...
(function () {
  ...
  script.text = JSON.stringify({
    ...
    "action.codePreviewSection.name": "在块中查看",
    ...
    "action.copiedCodeToClipboard.snackBarMessage": "代码已复制到剪贴板",
    "action.copiedLinkToClipboard.snackBarMessage": "已复制到剪贴板",
    "action.copiedPropertyToClipboard.snackBarMessage": "属性复制到剪贴板",
    "action.copiedToClipboard.snackBarMessage": "复制到剪贴板",
    "action.copy.name": "复制",
    "action.copyDirectLink.name": "复制源链接",
    ...
    "action.languageMode.solidity": "Solidity(Solidity)",
    ...
    "action.showSplitViewFormat.name": "拆分视图",
    ...
    "appUpdateListener.reinstallDesktopApp.message":
      "要获得最新功能，请下载并重新安装桌面应用程序<textlink></textlink>。",
    ...
    "attributionTooltip.lastEditedByTitle": "最终编辑",
    ...
    "auditlog.logTable.eventColumn.header": "活动",
    ...
    "blockHelpers.deepnoteBlockType": "深度笔记",
    ...
    "blockPermissionsSettings.permissionItem.teamAccess":
      "{teamName}的所有成员",
    ...
    "blockPermissionsSettings.teamPermission.subtitle":
      "{nonGuestTeamMembersCount、plural、other{nonGuestTeamMembersCount}不是名来宾的团队成员}}",
    "blockPermissionsSettings.teamPermission.tooltip":
      "适用于所有团队成员(总计{memberCount}名)，而不是{teamName}中的来宾。",
    ...
    "capabilitiesTooltip.mixedAccess.readContent.enabled": "内容可读。",
    "capabilitiesTooltip.mixedAccess.title": "复合访问",
    "capabilitiesTooltip.mixedaccess.insertContent.disabled": "无法输入内容。",
    "capabilitiesTooltip.mixedaccess.insertContent.enabled": "允许您输入内容。",
    "capabilitiesTooltip.mixedaccess.readContent.disabled": "无法读取内容。",
    "capabilitiesTooltip.mixedaccess.updateContent.disabled": "无法更新内容。",
    "capabilitiesTooltip.mixedaccess.updateContent.enabled": "更新内容。",
    ...
    "capabilitiesTooltip.userAccess.readUserEmailAddresses.enabled":
      "允许读取用户电子邮件地址",
    "capabilitiesTooltip.userAccess.readUsers.disabled": "用户不可读",
    "capabilitiesTooltip.userAccess.readUsers.enabled": "允许用户读取",
    ...
    "codeBlock.mobileCodePreviewMenu.title": "预览代码",
    ...
    "collectionTabBar.showMoreViews.title": "{moreViewsCount}查看更多",
    "collectionViewBlock.action.filter.title": "过滤器",
    "collectionViewBlock.action.navigateToOriginal.tooltip":
      "点击以回到原始数据库。",
    "collectionViewBlock.action.newItem.title": "新建",
    "collectionViewBlock.action.noDateButton.noProperty.label":
      "无日期({noDateTotal})",
    "collectionViewBlock.action.viewSettings.title": "设置",
    "collectionViewBlock.actionBar.offlineTemplatePicker.message":
      "在线使用模板。",
    "collectionViewBlock.noSourcePlaceholder.title": "未指定数据库",
    "collectionViewBlock.placeholder.title": "无数据源",
    "collectionViewBlock.setSourceButton.title": "指定数据库",
    "collectionViewGroupMenu.groupByDropdown.defaultChoice": "无",
    "collectionViewSelect.ViewSearch.label": "请输入您的搜索词。",
    ...
    "cookieConsentSnackbar.description": "Notion使用cookie来改善用户体验。",
    "cookieSelector.captions.necessary": "网站运行所需的cookie。",
    "cookieSelector.captions.performance": "用于改善用户体验。",
    "cookieSelector.captions.preference": "用于记住用户选择的功能。",
    "cookieSelector.captions.targeting": "用于衡量广告效果。",
    "cookieSelector.done.label": "完成",
    "cookieSelector.label.acceptAll": "允许全部",
    "cookieSelector.label.custom": "自定义",
    "cookieSelector.select": "自定义Cookie",
    ...
    "database.editButton.configureRollupTooltip": "汇总配置",
    "database.editButton.editEmailTooltip": "编辑电子邮件",
    ...
    "database.filterBar.filter.title": "过滤器",
    "database.filterBar.mobileSearch.placeholder": "输入搜索词",
    "database.filterBar.reset.title": "重置",
    "database.filterBar.search.title": "搜索",
    "database.filterMenu.addFilterButtonTitle": "添加筛选器",
    "database.filterMenu.addFilterGroup2ButtonTitle": "添加过滤器组",
    ...
    "database.filterOperatorValue.checkboxPlaceholder.title": "选择值",
    ...
    "database.filterValue.checkboxType.checked.title": "已标记",
    ...
    "database.filterValue.numberType.searchPlaceholder": "输入值",
    ...
    "database.filterValue.personType.searchPersonPropertyMenuItem.errorMessage":
      "出现问题。",
    "database.filterValue.personType.searchPlaceholder": "搜索用户",
    "database.filterValue.personType.title": "用户",
    "database.filterValue.relationType.searchPlaceholder": "搜索页面",
    "database.filterValue.relationType.title": "关系型",
    ...
    "database.filterValue.textType.searchPlaceholder": "输入值",
    ...
    "database.searchInputPlaceholder": "请输入您的搜索词。",
    ...
    "database.viewSettings.configureSelfRelationTab.samePropertyOption.caption":
      "<b>进一步创建新属性，并双向同步。在</b>“操作”数据库中分别创建“父任务”和“子任务”属性时，请使用此选项。",
    "database.viewSettings.configureSelfRelationTab.samePropertyOption.title":
      "在单个属性中显示",
    "database.viewSettings.configureSelftRelationTab.title": "新建关系",
    ...
    "database.viewSettings.createCollectionTab.title": "创建新数据库",
    "database.viewSettings.createCustomFilterTab.doneButton.title": "完成",
    "database.viewSettings.createCustomFilterTab.title": "新建过滤器",
    ...
    "database.viewSettings.createFilterTab.suggestedFilters.title":
      "推荐筛选器",
    "database.viewSettings.createFilterTab.title": "新建过滤器",
    "database.viewSettings.createPropertyTab.title": "新建属性",
    "database.viewSettings.createViewSourceTab.title": "添加新视图",
    ...
    "database.viewSettings.filterTab.title": "过滤器",
    "database.viewSettings.filterTab.turnOnByDefault.title": "默认打开",
    "database.viewSettings.filtersTab.defaultOn.title": "打开默认值",
    "database.viewSettings.filtersTab.newFilter.title": "新建过滤器",
    "database.viewSettings.filtersTab.title": "过滤器",
    ...
    "database.viewSettings.mainTab.filterButton.filters.title":
      "{numberOfFilters，plural，other{{numberOfFilters}个过滤器}}",
    ...
    "database.viewSettings.mainTab.title": "设置视图",
    ...
    "database.viewSettings.propertyTab.deleteProperty.modal.prompt":
      "是否确实要删除此属性？",
    "database.viewSettings.propertyTab.duplicateButton.title": "复制",
    ...
    "database.viewSettings.propertyTab.showButton.title": "视图",
    "database.viewSettings.propertyTab.title": "编辑属性",
    "database.viewSettings.selectRelationSourceTab.inputPlaceholder":
      "搜索数据库",
    "database.viewSettings.selectRelationSourceTab.title": "新建关系",
    ...
    "database.viewSettings.sourceTab.newDatabaseMenuItem.title":
      "新数据库“{filterText}”",
    "database.viewSettings.sourceTab.showMore.title": "{showMore}查看更多",
    "database.viewSettings.sourceTab.suggestedSources": "数据库推荐",
    ...
    "deepnoteBlock.embeds.button.label": "Deepnote嵌入",
    "deepnoteBlock.embeds.caption": "与包含公共链接的Deepnote块兼容",
    "deepnoteBlock.placeholder": "Deepnote嵌入",
    ...
    "developerIntegrationCard.dropdown.delete": "删除合并",
    ...
    "developerIntegrationForm.capabilities.caption":
      "当用户批准合并时，系统会向用户显示这些请求的功能。如果您需要更多帮助，请查看<inlinetextlink>开发者文档</inlinetextlink>。",
    ...
    "developerIntegrationForm.capabilities.insert_content.caption":
      "请求创建新内容。",
    "developerIntegrationForm.capabilities.insert_content.title": "输入内容",
    ...
    "developerIntegrationForm.capabilities.read_content.caption":
      "请求读取内容。",
    "developerIntegrationForm.capabilities.read_content.title": "阅读内容",
    ...
    "developerInternalIntegraion.integrationType.integration.caption":
      "任何Notion用户都可以使用。要发布到集成库，可能需要审阅和验证。",
    ...
    "embedBlock.expandFullScreen.button.label": "扩展",
    ...
    "embedMenu.action.deepnote": "Deepnote嵌入",
    ...
    "externalObjectInstanceEmbedPreview.expandButton.label": "扩展",
    ...
    "helpButton.sendUsAMessage.tooltip.intercom.disabled":
      "请务必接受功能cookie以启用短信功能。您可以在{br}Notion设置中更改cookie设置。{br}或发送电子邮件至team@makenotion.com。",
    "helpButton.twitter.menuItem": "Twitter – @{notionHandle}",
    "helpButton.whatsNew.menuItem": "新消息",
    "hexBlock.embeds.button.label": "Hex嵌入",
    "hexBlock.embeds.caption": "与包含公共访问的Hex单元格兼容",
    "hexBlock.placeholder": "Hex嵌入",
    ...
    "iFramePreview.imagelessAreaLabel": "点击以导入嵌入。",
    "iFramePreview.pillLabel": "载入嵌入",
    ...
    "moveBlockMenu.learnMoreButton.title": "了解详情",
    "moveBlockMenu.learnMoreButton.tooltip": "选择要移动的位置",
    ...
    "moveBlockMenu.spaceSwitcher.menuTitle": "工作空间",
    ...
    "newBlock.deepnote.description": "嵌入Deepnote块。",
    "newBlock.deepnote.fuzzySearchKeywords": "深度笔记",
    "newBlock.deepnote.title": "深度笔记",
    ...
    "newBlock.hex.description": "嵌入Hex细胞。",
    ...
    "newBlock.toggleFormatHeader.description":
      "切换标题可以隐藏或显示其中的内容。",
    "newBlock.toggleFormatHeader.keywords": "标题格式切换为第一个标题",
    "newBlock.toggleFormatHeader.title": "标题切换1",
    "newBlock.toggleFormatSubHeader.description":
      "切换标题可以隐藏或显示其中的内容。",
    "newBlock.toggleFormatSubHeader.keywords": "将标题格式切换为第二个子标题",
    "newBlock.toggleFormatSubHeader.title": "标题切换2",
    "newBlock.toggleFormatSubSubHeader.description":
      "切换标题可以隐藏或显示其中的内容。",
    "newBlock.toggleFormatSubSubHeader.keywords": "切换标题格式为第三个子标题",
    "newBlock.toggleFormatSubSubHeader.title": "标题切换3",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.insertContent.description":
      "“{integrationName}”集成将允许您将新内容或子页面添加到我下一步选择的页面。以后也可以通过共享菜单共享“{integrationName}”集成和页面。",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.readContent.description":
      "“{integrationName}”集成将允许您查看我下一步选择的页面。以后也可以通过共享菜单共享“{integrationName}”集成和页面。",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.updateContent.description":
      "“{integrationName}”集成将允许您编辑我下一步选择的页面。以后也可以通过共享菜单共享“{integrationName}”集成和页面。",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.viewUsers.detail":
      "“{integrationName}”集成将允许您查看工作区中所有成员和来宾的用户名和基本信息图像等基本信息(电子邮件地址除外)。",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.viewUsersAndEmail.detail":
      "“{integrationName}”集成将允许您查看工作区中所有成员和来宾的基本信息，如用户名、个人资料图像和电子邮件地址。",
    ...
    "oauthAuthorizationPage.permissionStep.warning.body":
      "如果继续，可能会共享敏感信息。Notion不审查第三方集成，例如“{integrationName}”集成。通过“{integrationName}”中的<privacypolicylink>隐私政策</privacypolicylink>和<termsofservicelink>服务条款</termsofservicelink>查看如何处理用户数据。",
    "oauthAuthorizationPage.permissionStep.warning.title":
      "确保集成“{integrationName}”({redirectUriDomain})可信。",
    ...
    "pageOnAppStoreSetting.description.message":
      "选择在启动Notion或切换工作空间时要显示的项目。",
    "pageOnAppStoreSetting.firstPage.label": "侧边栏的父页面",
    "pageOnAppStoreSetting.lastVisitedPage.label": "上次访问页面",
    ...
    "peekTopbar.peekNavDownArrow.tooltip": "“数据库下一页”页",
    "peekTopbar.peekNavUpArrow.tooltip": "“移植数据库”页",
    ...
    "profileSettings.cookieAcceptance.subtitle":
      "为改善用户体验，请允许使用Notion的Cookie。",
    "profileSettings.cookieAcceptance.title": "允许cookie",
    ...
    "sidebar.menuListTeam.createLabel": "新团队",
    ...
    "sidebar.outlinerTeamToggleButton.viewLabel": "团队设置",
    ...
    "sidebarCreateTeamModal.teamDescription.label":
      "系统地整理页面，一起工作的空间。",
    "sidebarCreateTeamModal.teamScreen.closedTeam.caption": "非公开",
    "sidebarCreateTeamModal.teamScreen.closedTeam.description":
      "只有团队成员才能访问团队的页面。",
    "sidebarCreateTeamModal.teamScreen.closedTeam.title": "私人团队",
    ...
    "sidebarCreateTeamModal.teamScreen.openTeam.caption": "公开",
    "sidebarCreateTeamModal.teamScreen.openTeam.description":
      "工作区中的所有成员都可以访问团队中的页面。",
    "sidebarCreateTeamModal.teamScreen.openTeam.title": "公开团队",
    ...
    "sidebarTeamModal.aboutScreen.descriptionPlaceholder": "添加注释",
    "sidebarTeamModal.aboutScreenMembers.label": "成员",
    "sidebarTeamModal.aboutScreenTeamOwner.label": "团队所有者",
    "sidebarTeamModal.aboutScreenTopLevelPages.label": "“团队”页",
    ...
    "spaceSettingsSidebar.auditLogTab.title": "审核日志",
    ...
    "spaceSettingsSidebar.notificationsAndSettings.title": "我的通知和设置",
    ...
    "spaceSubscriptionBilling.changeVATIDModal.subtitle": "请输入国家代码。",
    ...
    "spaceSubscriptionBilling.vatCountryCode.subtitle": "请输入国家代码。",
    ...
    "teamBrowser.teamCard.LeaveTeamLast.prompt":
      "你不能离开这个团队，因为这是团队的唯一所有者。邀请其他团队所有者可以离开。",
    "teamPermissionSettings.closeSpacePermissionItem.description":
      "由于此设置处于关闭状态，只有{num}名团队成员具有访问权限。",
    "teamPermissionSettings.generalSection.spacePermission": "一般",
    "teamPermissionSettings.generalSection.teamPermission": "团队成员",
    "teamPermissionSettings.member.permissionItem.overrideWarning":
      "此成员不受默认团队权限的约束，即使更改了默认团队权限，也不受影响。",
    "teamPermissionSettings.member.search.zeroState": "无成员",
    "teamPermissionSettings.openSpacePermissionItem.description":
      "由于此设置已打开，{num}名工作空间成员对此团队具有访问权限。",
    "teamPermissionSettings.permissionItem.rolePill.owner": "团队所有者",
    "teamPermissionSettings.permissionItem.rolePill.pageGuest": "页面来宾",
    "teamPermissionSettings.permissionItem.rolePill.teamGuest": "团队来宾",
    "teamPermissionSettings.teamPermissionItem.description":
      "{num}名团队成员和新加入的用户可以访问此团队。",
    "teamPermissionSettings.unknownGroup": "未知组",
    "teamPermissionsInviteWithModal.openModal": "添加成员",
    "teamPermissionsSettings.closeTeamToOpen.accept": "允许所有人访问",
    "teamPermissionsSettings.closeTeamToOpen.dialogDescription":
      "是否允许工作区所有成员访问此团队的页面？",
    "teamPermissionsSettings.closedTeam.noAccessLabel": "无法访问",
    "teamPermissionsSettings.openTeamToClose.accept": "删除访问",
    "teamPermissionsSettings.openTeamToClose.dialogDescription":
      "是否确实要删除所有工作区成员的访问权限？只有团队成员具有访问权限，新成员必须获得邀请才能参与。",
    ...
    "templateHelpers.templates.teamsGettingStarted": "开始创建团队",
    ...
    "unfurling.asana.asanaProject": "Asana项目",
    ...
    "unfurling.dropbox.dropboxFile": "Dropbox文件",
    ...
    "unfurling.figma.figmaFile": "Figma文件",
    "unfurling.figma.figmaLastModifiedBy": "{value}上次修改",
    "unfurling.github.githubCommit": "提交",
    "unfurling.github.githubCommitted": "提交时间：{value}",
    "unfurling.github.githubIssue": "Issue{value}",
    "unfurling.github.githubIssues": "Issues{value}个",
    ...
    "unfurling.github.githubPullRequests": "拉式请求{value}个",
    ...
    "userPermissionsMenu.mixedAccessItem.caption": "具有复合访问。",
    "userPermissionsMenu.mixedAccessItem.label": "复合访问",
