...
(function () {
  ...
  script.text = JSON.stringify({
    ...
    "action.backgroundColor.default.fuzzySearchKeyword": "默认黑白",
    ...
    "action.databaseLock.fuzzySearchKeywords": "数据库 锁定",
    ...
    "action.fullWidth.fuzzySearchKeywords": "全宽",
    ...
    "action.pageLock.fuzzySearchKeywords": "锁定 页面",
    ...
    "action.wrapCode.fuzzySearchKeywords": "代码换行",
    ...
    "newBlock.header.fuzzySearchKeywords": "标题 1 #",
    "newBlock.header.title": "标题 1",
    "newBlock.image.description": "上传或以链接嵌入。",
    "newBlock.image.fuzzySearchKeywords": "图片 图像 图形",
    ...
    "newBlock.subSubHeader.fuzzySearchKeywords": "小标题 子标题 3 ###",
    ...
    "newBlock.text.fuzzySearchKeywords": "纯文本 文本 纯文字 文字",
