...
(function () {
  ...
  script.text = JSON.stringify({
    ...
    "helpButton.onboardingChecklist.menuItem": "入门",
    ...
    "onboardingChecklistButton.stageTracker":
      "{totalStageNumber}个中的{currentStageNumber}个",
    ...
    "updatesModal.archiveTab.emptyPrompt": "此处显示收件箱中已存档的更新。",
