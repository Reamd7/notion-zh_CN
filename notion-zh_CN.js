...
(function () {
  ...
  script.text = JSON.stringify({
    ...
    "auditlog.actionNames.scim_token_revoked": "已撤销 API SCIM 令牌",
    ...
    "auditlogEventFilter.actionNames.saml_enforce_toggled":
      "已切换 SAML 强制执行",
    "auditlogEventFilter.actionNames.saml_toggled": "已切换 SAML 启用",
    ...
    "auditlogEventFilter.actionNames.workspace_domain_changed": "域名已更改",
    ...
    "blockPermissionsSettings.teamOwnerPermission.subtitle":
      "{teamOwnersCount, plural, other {{teamOwnersCount} 个团队所有者}}",
    "blockPermissionsSettings.teamOwnerPermission.tooltip":
      "适用于 {teamName} 的所有所有者（共 {ownerCount} 个）。",
    "blockPermissionsSettings.teamPermission.subtitle":
      "{membersCount, plural, other {{nonGuestTeamMembersCount} 个团队成员}}",
    ...
    "connectionErrorIndicator.details.message":
      "自 {sinceSomeTimeAgo} ，保存您的更改时发生错误。稍后我们将重试",
    ...
    "cookieConsent.bannerDisclaimer.message":
      "Notion 使用 cookie 来改善您的体验。有关详细信息，请参阅 <cookielink>Cookie 声明</cookielink>。",
    ...
    "cookieConsent.reloadAfterSave.message":
      "Notion 将重新加载以使您的 cookie 偏好设定生效。点击 OK 继续。",
    ...
    "database.viewBlockSettings.appConfiguration.saveForEveryone":
      "为所有人保存",
    "database.viewBlockSettings.appConfiguration.title":
      "自定义 {viewBlockName}",
    ...
    "database.viewBlockSettings.databases.linkedDatabases": "已链接数据库",
    ...
    "database.viewSettings.createFilterTab.showMoreTitle":
      "其他 {moreCount} 个",
    ...
    "database.viewSettings.editRelation.targetLink.title": "目标",
    ...
    "defaultTeamsInput.defaultTeamList.title": "团队",
    ...
    "developerIntegrationView.publishedIntegrationWarning":
      "一旦您保存对此页面的更改，您在 Notion <integrationgallerylink>集成画廊</integrationgallerylink>中的列表将立即更新。",
    ...
    "developerInternalIntegration.integrationType.internal.caption":
      "仅适用于您作为其管理员的工作区。集成可以自动安装到这些工作区，不需要审核。",
    ...
    "helpButton.survey.menuItem": "参加调查",
    ...
    "leaveTeam.confirmDialog.description.label":
      "是否确定要退出 {team}？此团队不再显示在侧边栏中，您可能会失去权限。",
    "leaveTeam.onlyTeamMeberLeft.label":
      "你不能退出此团队，因为你是唯一的团队所有者。邀请其他团队所有者，您才能退出。",
    ...
    "localDatabase.errorFixes.chromeUpgradeCorruptedSettings":
      "您的 Chrome 个人资料可能已损坏。要获得更一致的体验，请下载 Notion 桌面应用：https://notion.so/desktop",
    ...
    "manageTeamsOwnerFilter.filterTitle.withSpecifiedOwner":
      "所有者：{teamOwnerName}",
    "manageTeamsOwnerFilter.noOwnersFilterOption": "没有所有者的团队",
    "manageTeamsOwnerFilter.searchOwner.placeholder": "搜索团队所有者...",
    ...
    "manageTeamsTable.emptyManageTeamTableDisclaimer.teamsFilteredOut":
      "找不到任何团队。<linkbutton>请重置筛选器</linkbutton>",
    ...
    "moveToModal.teamsSection.title": "团队",
    ...
    "newBlock.toggleFormatHeader.fuzzySearchKeywords": "切换标题 1 # h1",
    ...
    "oauthAuthorizationPage.error.integrationNotApproved.title":
      '您无权将集成"{integrationName}"添加到 {workspaceName}',
    ...
    "outlinerTeamOverflow.restoreArchivedTeam.disabledTooltipText":
      "只有团队所有者才能恢复存档的团队。",
    "outlinerTeamOverflow.teamActions.restoreLabel": "恢复团队",
    ...
    "pricingGrid.planAttribute.contentApi.tooltip.v3":
      "<p>使用 Notion API 为您的团队构建自定义集成。</p>",
    ...
    "pricingGrid.planAttribute.sharingPermissions.tooltip":
      "<p>设置更精细的权限，以限制受邀人员与他人分享页面。</p>",
    "pricingGrid.planAttribute.sso.title": "SAML 和单点登录（SSO）",
    "pricingGrid.planAttribute.teams.title": "团队",
    "pricingGrid.planAttribute.teams.tooltip":
      "<p>让您可以在不同的团队（如营销、工程或设计）中创建和组织所有文档。 </p>",
    "pricingGrid.planAttribute.teams.value.limitedTeams": "3 个团队",
    "pricingGrid.planAttribute.teams.value.noTeams": "没有团队",
    "pricingGrid.planAttribute.teams.value.unlimited": "无限的团队",
    ...
    "sidebar.outlinerTeamToggleButton.joinLabel": "加入团队",
    ...
    "subscriptionSettings.upgradeToBusinessDialog.message":
      "您将以每位成员每月 {price} 的价格订阅 Notion 商业版。{br}系统将在扣除帐户余额后，按比例向您收取费用。",
    ...
    "teamBrowser.teamCard.leaveTeam.defaultTeamTooltip":
      "您不能退出此团队，因为它已与整个组织同步。",
    "teamBrowser.teamCard.leaveTeam.groupTooltip":
      "您是{groupNames}的成员，所以不能离开此团队。",
    ...
    "teamLeaveButton.confirmDialog.description":
      "是否确定离开 {team}？此团队不再显示在侧边栏中，您可能会失去权限。",
    ...
    "teamMemberPermissionSettings.leaveCloseTeam.confirmation.description":
      "离开此团队意味着您将失去对此团队中的所有页面的访问权限，在侧边栏中再也看不到此团队。",
    "teamMemberPermissionSettings.leaveLastTeam.confirmation.description":
      "您只隶属于一个团队，所以不能离开此团队。加入其他团队，您才能离开",
    ...
    "teamMemberPermissionSettings.leaveTeamAsLastOwner.confirmation.description":
      "您是唯一的团队所有者，所以不能离开此团队。邀请其他团队所有者，您才能离开",
    ...
    "teamMemberPermissionSettings.makeTeamOwner.confirmation.message":
      "是否确定让{name}成为团队所有者？他们将能够编辑团队设置和权限。",
    ...
    "teamMemberPermissionSettings.removeSelfTeamOwner.confirmation.message":
      "是否确定要移除自己的团队所有者身份？您将无法再编辑团队设置和权限。",
    "teamMemberPermissionSettings.removeTeamOwner.confirmation.message":
      "是否确定要移除团队所有者 {name}？他们将无法再编辑团队设置和权限。",
    ...
    "teamSettings.defaultTeam.subtitle":
      "将工作区中的每个人以及新的工作区成员添加到此团队。成员将无法退出。",
    "teamSettings.defaultTeam.title": "与整个组织同步",
    ...
    "teamSettings.disableGuestsOverride.confirmationTitle":
      "确定要允许访客加入此团队吗？默认情况下，不允许访客加入此工作区中的团队。",
    ...
    "teamSettings.disablePublicPagesOverride.confirmationTitle":
      "确定要允许公开团队页面？默认情况下，此工作区中的页面不能设为公开。",
    ...
    "teamSettings.enableDefaultTeam.confirmationModal.message":
      "确定要将此团队与整个组织同步？工作区中的每个人以及未来的工作区成员都将添加到该团队中。",
    ...
    "unfurlingHelpers.authenticatedErrorDescription.accessDenied":
      "资源所有者或授权服务器拒绝了该请求。请与您的组织或资源所有者联系，确保启用 OAuth 安装。",
    ...
    "unfurlingHelpers.unfurlResponseErrorDescription.notFound":
      "找不到此链接的资源信息。它可能已不存在，或者您可能没有适当的访问权限。",
    "unfurlingHelpers.unfurlResponseErrorDescription.rateLimited":
      '"{integrationName}" 收到了太多来自您或您所在组织的请求。请等待几分钟，然后重试。',
