...
(function () {
  ...
  script.text = JSON.stringify({
    ...
    "action.databaseLock.tooltip": "锁定数据库属性和视图以防止意外编辑。你仍然可以在内部创建和编辑页面。",
    ...
    "action.insertInlineEquation.fuzzySearchKeyword": "TeX LaTex 方程式 数学 行内 公式 $",
    ...
    "action.linkedDatabaseLock.tooltip": "锁定被链接的数据库的属性和视图以防止意外编辑。你仍然可以在内部创建和编辑页面。",
    ...
    "action.ruleCountForSorts.label": "{ruleCount, plural, other {{ruleCount} 条规则}}",
    ...
    "activateReferral.dialogError.emailNotEligible.errorMessage": "该邮箱地址不符合引荐计划的使用条例。如果你认为这是个错误，请与支持人员联系。",
    ...
    "activity.collectionPropertyCreated.header": "{numberOfAuthors, plural, other {{authorOrAuthors}在{collectionTitle}中添加了属性 {collectionPropertyTitle}}}",
    ...
    "activity.restorePermissionsForActivity.header": "{numberOfAuthors, plural, other {{authorOrAuthors}恢复了{pageOrSpaceName}其继承的访问权限}}",
    "activity.restrictPermissionsForActivity.header": "{numberOfAuthors, plural, other {{authorOrAuthors}限制了{pageOrSpaceName}的访问权限}}",
    ...
    "activity.userInvitedActivityNavigableBlockByBot.header": "你已被邀请加入{blockName}",
    "activity.userInvitedActivityOtherInvite.header": "{numberOfAuthors, plural, other {{authorOrAuthors}邀请你加入{spaceName}}}",
    "activity.userInvitedActivityOtherInviteByBot.header": "你已被邀请加入{spaceName}",
    ...
    "apiSettingsPage.bots.description": "机器人只能访问与当前工作区分享的内容。要访问私人页面，请从“分享”菜单直接与机器人分享页面。<learnmorelink>了解更多</learnmorelink>",
    "apiSettingsPage.bots.title": "机器人",
    "appUpdateListener.downloadAndReinstallDesktopApp.message": "<textlink>下载并重新安装</textlink>你的{isMacApp, select, true { Mac 应用} other { Windows 应用}}以离线工作并获取最新功能。",
    "appUpdateListener.downloadingDesktopApp.message": "我们正在更新你的{isMacApp, select, true { Mac 应用} other { Windows 应用}}以便你可以离线工作（ {processPercent} ）",
    ...
    "block.selectableAddMenu.tooltip": "点击<mediumcolor>在下面添加一个块</mediumcolor>",
    ...
    "blockDiscussionMenu.emptyStatte.noResolvedCommentsMessage": "没有已解决的评论。",
    ...
    "blockPermissionsSettings.botPermission.tooltip": "这是你工作区中的一个机器人。",
    ...
    "blockPermissionsSettings.confirmationDialog.workspace.message": "确定与工作区分享该页面吗？<semibold>所有 {memberCount} 位成员都将可以访问。</semibold>",
    ...
    "blockPermissionsSettings.groupPermission.canAdmin": "{numberOfGroupMembers, plural, one {{numberOfGroupMembers} 位群组成员} other {{numberOfGroupMembers} 位群组成员}}可以编辑和分享",
    "blockPermissionsSettings.groupPermission.canComment": "{numberOfGroupMembers, plural, one {{numberOfGroupMembers} 位群组成员} other {{numberOfGroupMembers} 位群组成员}}可以发表评论",
    "blockPermissionsSettings.groupPermission.canEdit": "{numberOfGroupMembers, plural, one {{numberOfGroupMembers} 位群组成员} other {{numberOfGroupMembers} 位群组成员}}可以编辑",
    "blockPermissionsSettings.groupPermission.canRead": "{numberOfGroupMembers, plural, one {{numberOfGroupMembers} 位群组成员} other {{numberOfGroupMembers} 位群组成员}}可以查看",
    "blockPermissionsSettings.groupPermission.none": "{numberOfGroupMembers, plural, other {{numberOfGroupMembers} 位群组成员}}",
    "blockPermissionsSettings.groupPermission.tooltip": "将该页面显示在{groupName}群组成员的<boldtext>共享</boldtext>侧边栏分组中。",
    "blockPermissionsSettings.groupPermissionUsers.tooltip": "其他 {countRemainingUsers} 位⋯",
    "blockPermissionsSettings.inheritedPermissions.tooltip": "访问权限基于{inlineIconAndName}。请前往该页面更改权限。",
    ...
    "blockPermissionsSettings.privatePermissions.tooltip": "只有你可以访问该页面。",
    "blockPermissionsSettings.publicLinkInfo.tooltip": "该页有公共链接访问权限，拥有链接的任何人都可以查看。",
    "blockPermissionsSettings.publicPermission.canComment": "任何有链接的人都可以发表评论",
    "blockPermissionsSettings.publicPermission.canEdit": "任何有链接的人都可以编辑和评论",
    "blockPermissionsSettings.publicPermission.canRead": "任何有链接的人都可以查看",
    "blockPermissionsSettings.publicPermission.none": "发布并与任何人分享链接",
    "blockPermissionsSettings.publicPermission.tooltip": "知道链接的任何人都可以访问该页面。",
    ...
    "blockPermissionsSettings.spacePermission.canAdmin": "{numberOfWorkspaceMembers, plural, one {{numberOfWorkspaceMembers} 位工作区成员} other {{numberOfWorkspaceMembers} 位工作区成员}}可以编辑和分享",
    "blockPermissionsSettings.spacePermission.canComment": "{numberOfWorkspaceMembers, plural, one {{numberOfWorkspaceMembers} 位工作区成员} other {{numberOfWorkspaceMembers} 位工作区成员}}可以发表评论",
    "blockPermissionsSettings.spacePermission.canEdit": "{numberOfWorkspaceMembers, plural, one {{numberOfWorkspaceMembers} 位工作区成员} other {{numberOfWorkspaceMembers} 位工作区成员}}可以编辑",
    "blockPermissionsSettings.spacePermission.canRead": "{numberOfWorkspaceMembers, plural, one {{numberOfWorkspaceMembers} 位工作区成员} other {{numberOfWorkspaceMembers} 位工作区成员}}可以查看",
    "blockPermissionsSettings.spacePermission.none": "{numberOfWorkspaceMembers, plural, other {{numberOfWorkspaceMembers} 位工作区成员}}",
    "blockPermissionsSettings.spacePermission.tooltip": "将该页面显示在工作区所有成员的<boldtext>工作区</boldtext>侧边栏分组中。",
    "blockPermissionsSettings.userPermissions.tooltip": "只有你和其他受邀成员或访客才能通过链接查看该页面。",
    "blockPermissionsSettings.workspacePermissions.tooltip": "该页具有工作区访问权限，工作区中的任何人都可以通过链接查看该页面。",
    ...
    "botActions.deleteBotConfirmationDialog.confirmDeleteBotButton.label": "是的",
    "botActions.deleteBotConfirmationDialog.confirmationMessage": "确定要删除{bot}吗？",
    "botHelpers.personalBotCaption": "只有你可以编辑该机器人。该机器人具有与你相同的所有权限。",
    "botHelpers.unnamedBot": "未命名的机器人",
    "botHelpers.workspaceBotCaption": "机器人只能在当前的工作区中工作。任何管理员都可以编辑该机器人。机器人无权访问私人页面，除非被特定邀请。",
    "botWithTokenSettings.deleteBot.label": "删除机器人",
    "botWithTokenSettings.revokeTokenModal.acceptButton.label": "撤销 API 令牌",
    "botWithTokenSettings.revokeTokenModal.message": "撤销 API 令牌？使用此令牌的所有 API 请求将不再成功。",
    "botWithTokenSettings.revokeTokenModal.tokenRevoked.message": "已成功吊销 API 令牌。新令牌现在可用。",
    ...
    "churnSurveyMenu.alternatives.alternativeOtherPlaceholder": "请告诉我们更多⋯",
    ...
    "churnSurveyMenu.continueDowngrade.downgradeMessage.personal": "你当前的计划将于 {periodEnd}到期。在此之前，你付费计划中的所有功能都将继续可用。你可以随时重新订阅或切换到另一个付费计划。{br}在此之后，该工作区将降级为免费的个人版计划，包含以下限制：<li>单人使用</li><li>工作区的访客限制为 5 个</li><li>上传文件每个最多 5MB</li><li>没有版本历史记录</li><li>没有与团队成员共享的工作区</li>",
    "churnSurveyMenu.continueDowngrade.downgradeMessage.team": "你当前的计划将于 {periodEnd}到期。在此之前，你付费计划中的所有功能都将继续可用。你可以随时重新订阅或切换到另一个付费计划。{br}在此之后，该工作区将降级为团队版的免费试用版，包含以下限制：<li>1,000 个块限制</li><li>上传文件每个最大 5MB</li><li>没有版本历史记录</li><li>没有批量导出</li><li>没有高级权限</li><li>没有权限群组</li>",
    ...
    "churnSurveyMenu.header.covidMessage": "💛 如果你受到 COVID-19 的影响，请<contactuslink>联系我们</contactuslink>以寻求帮助。",
    "churnSurveyMenu.header.description": "Notion 正在不断改善的旅途中。在你降级之前，我们希望你能告诉我们为什么，以便我们在今后为每个人提供更好的服务。感谢你的反馈意见。",
    "churnSurveyMenu.header.personal.title": "降级到个人版",
    "churnSurveyMenu.header.team.title": "降级到团队试用版",
    "churnSurveyMenu.other.otherFeedbackPlaceholder": "我们的团队将审核你的反馈，以使 Notion 变得更好。",
    ...
    "churnSurveyMenu.reasons.missingFeaturesPlaceholder": "让我们知道你还需要哪些功能⋯",
    ...
    "collectionEditViewButtonPopup.deleteViewConfirm.text": "确定要删除这个视图吗？",
    ...
    "collectionFilterMenuFilter.filterOperators.checkbox.order": "{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.date.order": "{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.file.order": "属性{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.multi_select.order": "属性{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.number.order": "属性{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.person.order": "属性{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.relation.order": "{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.select.order": "属性{operatorValue}{operator}",
    "collectionFilterMenuFilter.filterOperators.text.order": "属性{operatorValue}{operator}",
    ...
    "configureRelationModal.relationProperty.createModal.selfRelationPrompt.createNewPropertyOption.caption": "<b>在一个属性上显示并且不同步。在</b>“操作”数据库中创建一个“相关任务”属性时，请使用此选项。",
    ...
    "configureRelationModal.relationProperty.createModal.selfRelationPrompt.samePropertyOption.caption": "<b>进一步创建新属性并双向同步。在</b>“操作”数据库中分别创建“父任务”和“子任务”属性时，请使用此选项。",
    ...
    "confluenceImportErrors.uploadFileSizeExceeded.message": "文件不能超过 {maxSize}。",
    ...
    "connectionState.errorIndicator.cannotMakeEdits.detailedMessage": "你无法继续进行编辑：{errorMessage}。如果不能解决问题，请与支持人员联系。{usageInfoMessage}",
    ...
    "database.actionBar.noDateButton.noProperty.label": "无日期 ({noDateTotal})",
    "database.actionBar.noDateButton.withProperty.label": "{propertyString}为空 ({noDateTotal})",
    "database.actionBar.offlineTemplatePicker.message": "请连接网络以使用模板。",
    ...
    "database.aggregationDescription.percent_checked": "显示此属性已选页面的百分比。",
    ...
    "database.aggregationDescription.percent_unchecked": "显示此属性未选页面的百分比。",
    ...
    "database.boardView.addGroupButton.columnAlreadyExistsError.message": "该列已存在。",
    ...
    "database.boardView.columnActionMenu.deleteDialogMessage": "是否确定？此列内的所有块都将被删除。",
    ...
    "database.boardView.uncategorizedColumnTooltip": "任何<b>{name}</b>属性为空的项目都将转到此处。该栏无法删除。",
    ...
    "database.collectionGroupValue.dateGroup.week": "{year}年{month}月{startDay}日~{endDay}日的周",
    ...
    "database.confirmDialog.templatePickerItem.deleteMessage": "确定要删除该模板吗？",
    ...
    "database.editProperty.errorDialog.duplicateSelectValue.message": "该选择项已经存在。",
    "database.editProperty.errorDialog.missingSelectValue.message": "请输入一个值。",
    "database.editProperty.mobile.title": "编辑属性",
    "database.editProperty.name.tooltip": "名称列作为数据库中每个页面的标题，无法更改。",
    ...
    "database.filterAndSort.searchPersonPropertyMenuItem.errorMessage": "出了些问题。",
    ...
    "database.propertiesMenu.confirmActionDialog.deleteProperty.message": "确定要删除该属性吗？",
    ...
    "database.propertiesMenuActions.duplicateSearchText.label": "复制 副本 复本",
    ...
    "database.propertyTypeDescription.relation": "允许该数据库中的页面引用另一个数据库中的页面。",
    ...
    "database.relationProperty.createModal.databaseSelect.mobile.caption": "你希望链接到的数据库。",
    "database.relationProperty.createModal.databaseSelect.mobile.title": "数据库源",
    "database.relationProperty.createModal.databaseSelect.placeholder": "搜索数据库⋯",
    "database.relationProperty.createModal.description": "关联关系可以让你从其他数据库中链接页面。",
    "database.relationProperty.createModal.header": "创建与另一个数据库的关联关系",
    ...
    "database.relationProperty.createModal.selfRelationPrompt": "你选择了同一个数据库。被链接的页面应显示在哪个属性中？",
    "database.relationProperty.createModal.selfRelationPrompt.createNewPropertyOption.caption": "<b>不同步</b>：在“任务”数据库中搭建“相关任务”属性时，请使用此选项。",
    "database.relationProperty.createModal.selfRelationPrompt.createNewPropertyOption.title": "创建新属性",
    "database.relationProperty.createModal.selfRelationPrompt.mobileTitle": "自我关联型",
    "database.relationProperty.createModal.selfRelationPrompt.samePropertyOption.caption": "<b>双向同步</b>：在“任务”数据库中搭建“父任务”和“子任务”属性时，请使用此选项。",
    "database.relationProperty.createModal.selfRelationPrompt.samePropertyOption.title": "使用同一个属性",
    "database.relationProperty.newRelation.createNewPageLabel": "<medium>在</medium>{databaseNameWithIcon}<medium>中创建</medium>{pageName}页面",
    "database.relationProperty.newRelation.helpCaption": "了解关联关系和汇总",
    "database.relationProperty.newRelation.searchInitialState": "搜索以查找和链接页面",
    ...
    "database.searchRelation.createNewPageLabel": "在{databaseNameWithIcon}<medium>中创建一个</medium>名为{pageName}的<medium>新页面。</medium>",
    ...
    "database.timelineView.pricingBlock.description": "你当前的计划可以在时间轴视图中最多显示{tierLimit}行。升级以解除限额。",
    ...
    "developerIntegrationCardDropdown.delete.confirmationError": "输入的统一名称不匹配。",
    "developerIntegrationCardDropdown.delete.confirmationMessage": "此公共集成将被禁用，并从所有添加的工作区中删除。要确认，请输入此集成的名称。",
    "developerIntegrationCardDropdown.delete.confirmationTitle": "是否要删除{integrationName}集成？",
    ...
    "discussionInput.insertMention.button.tooltip": "输入您想要声明的用户、页面和日期。",
    ...
    "editPropertyButtonPopup.duplicatePropertyNameError": "此数据库中已经存在一个名为{propertyName}的属性。",
    ...
    "emailActivity.collectionRowDeleted.header": "{numberOfAuthors, plural, other {{authorOrAuthors}已删除{pageTitle}}}",
    ...
    "emailActivity.topLevelBlockWorkspaceDeleted.header": "{numberOfAuthors, plural, other {{authorOrAuthors}已删除工作区页面{pageTitle}}}",
    ...
    "emailActivity.userInvitedActivityGroupId.header": "{numberOfAuthors, plural, other {{authorOrAuthors}加你到{groupName}群组}}",
    ...
    "emailActivity.userInvitedActivityOtherInvite.header": "{numberOfAuthors, plural, other {{authorOrAuthors}邀请你到{spaceName}}}",
    "emailActivity.userInvitedActivityOtherInviteByBot.header": "你已被邀请加入{spaceName}",
    "emailActivitySection.authorPhrase.forMoreThanTwoAuthors.label": "{numberOfOtherAuthors, plural, other {<b>{firstAuthor}</b>、<b>{secondAuthor}</b>及其他 {numberOfOtherAuthors} 位}}",
    "emailActivitySection.authorPhrase.forNoAuthors.label": "没有人",
    "emailActivitySection.authorPhrase.forOneAuthor.label": "<b>{author}</b>",
    "emailActivitySection.authorPhrase.forTwoAuthors.label": "<b> {firstAuthor} </b>和<b> {secondAuthor} </b>",
    ...
    "emailChangeNotificationEmail.emailChanged.text": "你用于登录 Notion 的邮箱地址已被更改为 {newEmail}。如果你没有进行此项更改，请发送电子邮件至 team@makenotion 告知我们。",
    "emailChangeNotificationEmail.unintendedChange.message": "如果你没有进行此项更改，请发送电子邮件至 team@makenotion 告知我们。",
    "emailChangeSettings.downgradeEducationPlan.warning.message": "更改邮箱地址可能会将你的免费个人专业版（教育）计划的工作区降级为免费个人版。你不会丢失任何数据，但是需要升级才能重新使用付费功能。对这个有疑问吗？<sendmessagelink>给我们发送消息</sendmessagelink>。",
    ...
    "emailErrors.noExistingAccountForEmailAddress.message": "该邮箱地址没有关联的现有帐户。",
    ...
    "embedError.unsupportedContentType": "此{family}格式（{extension}）无法在此设备上播放。",
    ...
    "enterpriseContactModal.initial.caption": "我们将与你合作制定你的专属计划。",
    ...
    "enterpriseContactModalQuestionSelect.question.plan_help": "选择计划时需要帮助",
    ...
    "exportEmail.downloadLinkPrompt": "<downloadlink>点击此处下载</downloadlink>",
    ...
    "faq.advancedPermissions.answer": "<p>在免费的团队试用版中，你可以在页面上将访问权限设置为“全部权限”、“可以查看”或“可以评论”。“全部权限”是指该人员可以编辑、评论、并与他人分享页面。</p> <p>在付费团队和企业版中，你可以向其他用户授予“可以编辑”访问权限，这样受邀人员可以在页面上进行编辑和评论，但不能与他人分享。如果你不希望你的内容泄漏到团队之外，这将特别有用。</p> <p> <contactsales>联系销售以了解更多</contactsales> </p>",
    "faq.advancedPermissions.question": "付费团队版和企业版提供哪些高级权限？",
    "faq.alreadyHadFreeAccount.answer": "<p>我们之前的免费计划的内容上限为 1,000 个块。现在，使用我们新的免费个人版，可以添加任意数量的内容，没有上限！ </p> <p>除此之外还有： </p> <ul> <li>让分享页面更加简单。只需分享公开链接，不需要将添加来宾或成员。</li> <li>最多可以邀请五位访客与你私下协作。如果想邀请更多访客，需要升级到个人专业版。</li> </ul> <p>你可以通过<pricinglink> notion.so/pricing </pricinglink>了解更多。</p>",
    "faq.alreadyHadFreeAccount.question": "我已经有一个免费的 Notion 帐户。有什么变化？",
    "faq.alreadyPayingForPersonal.answer": "<p>你已自动升级到新的个人专业版，无需额外支付费用！除了免费个人版的所有功能外，个人专业版还包括：</p><ul><li>文件上传无限制（免费版有 5MB 限制）</li><li>无限访客（免费版限制为5位）</li><li>长达 30 天的版本历史记录</li><li>优先客户支持</li></ul><p>你可随时切换回免费个人版计划。</p>",
    "faq.alreadyPayingForPersonal.question": "如果我已经为旧的个人版支付了费用怎么办？",
    "faq.alreadyPayingForPersonalAccessToFreeEducation.answer": "<p>是的！详细的升级说明可在<helpcenterlink>帮助中心</helpcenterlink>找到</p>",
    "faq.alreadyPayingForPersonalAccessToFreeEducation.question": "我已经支付了个人专业版计划的费用。我仍然可以免费使用吗？",
    "faq.cancelPlan.answer": "<p>取消付费计划时，当前计划会在计费周期结束前依旧生效，之后当前计划将被取消。</p>",
    ...
    "faq.changePlans.answer": "<p>升级或降级计划的工作原理与添加和删除成员相似。系统会根据更改方案时剩余的结算周期百分比来向你的帐户收费或返还余额。</p>",
    "faq.changePlans.question": "更改计划时会发生什么？",
    "faq.confluenceImport.answer": "<p>只需单击几下，你就可以将整个 Confluence 工作区转移到 Notion 中！只需按照<guidelink>导入指南</guidelink> 操作即可。</p>",
    "faq.confluenceImport.question": "如何将我的 Confluence 工作区导入Notion？",
    "faq.confluenceImportSizeLimit.answer": "<p>Confluence 导入的每个文件限制为 2.5GB。如果遇到限制，你可以尝试使用 Confluence 中的<bold>自定义导出</bold>选项来选择要导出的页面，建议你取消勾选带有许多附件的页面。</p>",
    "faq.confluenceImportSizeLimit.question": "有最大导入大小吗？",
    "faq.confluenceStorageLimit.answer": "<p>不会，导入的块不计入限制。但是，随后在导入的页面中<italic>创建的所有块</italic>都将像往常一样计入限制。</p>",
    "faq.confluenceStorageLimit.question": "导入的内容是否计入团队试用版的块存储限制？",
    "faq.deleteBlocks.answer": "<p>当然！像你手机或电脑上的存储限制一样，如果删除一些内容，则会释放更多空间。</p>",
    "faq.deleteBlocks.question": "我可以删除块来释放存储空间吗？",
    "faq.educationPlanGraduation.question": "我毕业后会怎样？",
    "faq.educationplanGraduation.answer": "<p>只要与大学的邮箱地址相关联，你就可以继续使用免费的学生帐户。毕业后，你将有机会更改邮箱地址并切换到付费计划。我们希望你能坚持使用我们的服务 🤞</p>",
    "faq.eligibleForEducation.answer": "<p>如果你满足以下条件，则符合资格：</p><ol><li>你是获得认可的学院或大学的学生或教育工作者。</li><li>你有一个学校的邮箱地址。我们目前不接受学生证或其他文件验证。</li></ol><p>如果你满足以下条件，则不符合资格：</p><ol><li>你是 K-12 学生或 K-12 教育工作者。但你仍然可以免费使用我们的个人版计划和无限量存储空间！在<pricinglink>价格页面</pricinglink>上了解更多信息。</li><li>你的 Notion 帐户与个人邮箱地址（例如 gmail.com 或 outlook.com 邮箱地址）相关联。</li></ol>",
    "faq.eligibleForEducation.question": "我是否有资格获取免费的个人专业版计划？",
    "faq.freePlanForEducation.answer": "<p>学生和教育工作者可免费获取新的个人专业版计划（通常为每月 US$5）！之前加入旧免费教育计划的工作区已经自动升级。除了所有个人版功能外，个人专业版还包括：</p><ul><li>无限访客数量（免费版限制为5位）</li><li>无限文件上传（免费版限制为每个文件 5MB）</li><li>30 天版本历史记录</li><li>优先客户支持</li><li>在 <studentslink>notion.so/students</studentslink> 或 <educatorslink>notion.so/educators</educatorslink> 了解更多</li></ul>",
    ...
    "faq.howCanTeamTryForFree.answer": "<p>我们希望你可以在付费之前轻松与多位成员一同玩转 Notion。方法如下：</p><ul><li>创建一个新的 Notion 工作区，并在询问如何使用时选择“团队”。</li><li>此时，新工作区将加入团队版的免费试用版。团队试用版让你免费体验团队版的部分功能，但含 1,000 个块的存储限制。达到该限制时，再决定是否升级。</li></ul>",
    "faq.howCanTeamTryForFree.question": "我的团队如何免费试用 Notion？",
    "faq.howToApplyCredit.answer": "<p>要使用积分，你必须先升级到任何付费计划。在升级过程中，你可以选择将部分或全部帐户积分应用于新计划。</p>",
    "faq.howToApplyCredit.question": "如何将积分应用于工作区？",
    "faq.howToApplyForStartupCredit.answer": "<p>简单！填写<formlink>这份表单</formlink>。</p>",
    "faq.howToApplyForStartupCredit.question": "如何申请获得 US$1,000 的积分？",
    "faq.howToEarnCredit.answer": "<p>你可以通过在不同设备上使用 Notion 并尝试新功能来赚取积分。请前往“设置与成员”中的“赚取积分”选项卡以了解更多。</p>",
    "faq.howToEarnCredit.question": "如何赚取积分？",
    "faq.importStorageLimit.answer": "<p>通过导入创建的内容不计入工作区的存储限制。我们希望确保你尽可能顺利地开始使用 Notion。</p>",
    "faq.importStorageLimit.question": "从其他应用导入内容会如何影响我的块存储限制？",
    ...
    "faq.maximumEarnedCredit.answer": "<p>是的，最多可以赚取 {maximumAmountInDollars} 的积分。</p>",
    "faq.maximumEarnedCredit.question": "赚取的积分有上限吗？",
    "faq.monthlyAndYearlyBilling.answer": "<p>是的！我们提供月付和年付计划，年付更便宜（大概可以省 20％）。举个例子，当你选择月付计划，团队版为每位成员每月 US$10，但如果选择年付计划，则每位成员每月 US$8。</p>",
    "faq.monthlyAndYearlyBilling.question": "有年付或月付的选项吗？",
    "faq.multipleTeams.answer": "<p>可以！你可以使用同一个电子邮件地址创建并加入多个团队。但是，每一个工作区拥有它自己的付费计划，需要单独升级。</p>",
    "faq.multipleTeams.question": "我可以在 Notion 上隶属于多个团队吗？",
    "faq.overGuestLimitInFreePlan.answer": "<p>你可以升级到没有访客限制的个人专业版。如果你经常和同一组人一起协作，则可升级为团队版。你还可以在“设置与成员”中查看和移除访客。</p>",
    "faq.overGuestLimitInFreePlan.question": "当我超出个人版的访客限制时会发生什么？",
    "faq.overStorageLimitInFreePlan.answer": "<p>你仍然可以像往常一样读取、编辑和移动现有内容块，但无法添加新的内容块。</p><p> 你可以删除现有内容块以释放存储。</p>",
    "faq.overStorageLimitInFreePlan.question": "当我超出团队试用版的块存储限制时会发生什么？",
    "faq.paymentFailure.answer": "<p>付款失败后，系统会通过邮件通知你。在账单逾期的第一个月，系统会最多重试 4 次付款。此后，如果付款失败，你将被降级为免费计划。</p>",
    "faq.paymentFailure.question": "如果付款失败会发生什么？比如我的信用卡过期了？",
    "faq.paymentProcessor.answer": "<p>我们使用 Stripe 处理你的付款。Stripe 是 Twitter、Pinterest 和 Lyft 等产品的支付提供商。我们不会直接处理或保存你的支付信息。</p>",
    "faq.paymentProcessor.question": "我的付款是如何处理的？",
    "faq.personalPricing.answer": "<p>如果你将工作区升级到个人专业版，将需支付固定费用（每月 US$5 或每年 US$48）。</p><p>访客完全免费，但需要在特定页面中添加。</p>",
    "faq.personalPricing.question": "如何计算个人专业版的定价？",
    "faq.portfolioCompaniesStartupDiscount.answer": "<p>我们希望听到你的声音！填写<partnerform>快速表单</partnerform>，我们将为你提供更多信息。我们特别有兴趣在主要技术中心之外寻找合作伙伴。</p>",
    "faq.portfolioCompaniesStartupDiscount.question": "我希望我的机构企业也能享受这一折扣。我如何才能成为合作伙伴？",
    "faq.previouslyHadMultipleMembers.answer": "<p>不用担心，你不必删除任何成员！在达到 1,000 个内容块之前，与你的旧免费计划不会有任何不同。在触发限制时，如果想继续添加内容，你可以： </p> <ul> <li>升级到团队版。</li> <li>仅为自己一个人创建一个新的个人版工作区，并无限期免费使用。</li> <li>移除成员，将工作区降级为个人版以移除块限制。</li> </ul> <p>注意：在移除工作区中的成员之前，请确保已备份其私人页面！ </p>",
    "faq.previouslyHadMultipleMembers.question": "如果我的免费工作区中有多位成员，怎么办？",
    "faq.refund.answer": "<p>在多数情况下，我们不提供退款。但是，如果你从工作区中删除成员或降级，我们会按比例返还积分到你的帐户。在下次向帐户收费时将优先使用余额支付。</p>",
    "faq.refund.question": "你们提供退款吗？",
    "faq.runOutOfCredit.answer": "<p>如果用完了积分，则会通过你提供的付款方式向你的帐户收取费用。</p>",
    "faq.runOutOfCredit.question": "如果我的积分耗尽会发生什么？",
    "faq.serviceLevelAgreement.answer": "<p>我们不提供标准 SLA。对于成员超过 100 人的团队，我们可以提供定制 SLA。</p><p><contactsales>联系销售以了解更多</contactsales></p>",
    "faq.serviceLevelAgreement.question": "你们有服务级别协议（SLA）吗？",
    "faq.startupCreditWorth.answer": "<p>Notion的<pricinglink>团队计划</pricinglink>通常每位成员每月支付 US$10。因此，对于一支 10 人的团队，US$1,000 的积分代表 10 个月的免费使用 Notion。对于一支 5 人的团队，就是 20 个月的免费使用 Notion，依此类推。</p>",
    "faq.startupCreditWorth.question": "在 Notion 里 US$1,000 积分值多少？",
    "faq.startupDiscountEligibility.answer": "<p>如果你满足两个条件，则有资格获得折扣：</p><p>1) 你正在使用 Notion 的团队计划为你的初创公司创建一个工作区。</p><p>2) 你正在与我们合作的孵化器或加速器之一合作（完整列表请参见<formlink>我们的表单</formlink> ）。</p><p>我们计划在将来扩大资格⋯⋯请继续关注。</p>",
    "faq.startupDiscountEligibility.question": "哪些人有资格？",
    "faq.studentDiscount.answer": "<p>个人专业版对学生和教育工作者是免费的。如果你是学生或教育工作者，就可和无限访客进行协作、使用版本历史记录等专业版功能。只需使用你的学校邮箱地址进行注册，即可获得这些功能。</p><p>如果你已经升级到个人专业版，请将与你的帐户关联的邮箱地址更改为学校的邮箱地址，以免费获得个人专业版。如果你之前已经在使用我们的旧版免费教育计划，则会自动升级到个人专业版。</p><p><helpcenterlink>请前往帮助中心了解更多。</helpcenterlink></p>",
    "faq.studentDiscount.question": "Notion 给学生提供任何优惠吗？",
    "faq.suggestStartupPartner.answer": "<p>在我们的名单上没有看到你的投资者？你可以做一些事情：</p><p>1) 给他们发个便条，鼓励他们加入该计划。</p><p>2) 用 #NotionForStartups 的标签向他们和 @NotionHQ 发推特，我们将接过话茬儿！</p><p>3) <applicationlink>申请积分</applicationlink>并在我们的表单中提出你的建议。</p>",
    "faq.suggestStartupPartner.question": "如何推荐一个 Notion 应当合作的合作伙伴？",
    "faq.teamAdminTools.answer": "<p>免费团队试用版中，工作区中的每位成员都是管理员。这意味着任何人都可以更改工作区设置并邀请他人进入团队。</p><p>如果你只想让特定的人具有管理员权限，我们建议你升级到完整的付费团队版。它附带的管理员工具，可以让你区分管理员和普通成员。成员无法编辑帐单信息或安全设置，也无法在工作区之外共享内容。</p>",
    "faq.teamAdminTools.question": "团队版随附哪些管理员工具？",
    "faq.teamPricing.answer": "<p>如果你将工作区升级到团队版，则会向每位成员将收取费用（每人每月 US$10 或每年 US$96）。例如，如果你使用月付计划，并有 5 位成员，则每月收取 US$50。</p><p>访客完全免费，但他们只能访问被邀请的特定页面。也就是说，访客不能看到侧边栏中的“工作区”分区内容。</p>",
    "faq.teamPricing.question": "如何计算团队版的定价？",
    "faq.teamTrial.answer": "<p>当系统在注册过程中询问你如何设置 Notion 时，选择“团队”，你将自动加入团队版的免费试用。你将可以使用付费团队版的大多数功能，但块存储限制为 1,000 个。如果你的团队想要添加更多内容，请升级到完整的团队版。上面有更详细的信息。</p>",
    "faq.teamTrial.question": "如何免费试用团队版？",
    "faq.useNotionForFree.answer": "<p>Notion 可以无限期免费使用。</p><p>作为个人，可以完全免费使用个人版。团队版有 1,000 个块限制的免费试用期，这样你可以在为团队升级前与团队免费试用 Notion。</p>",
    "faq.useNotionForFree.question": "我可以免费使用 Notion 吗？",
    "faq.whatHappensToFreeGuests.answer": "<p>你仍可添加多达 5 位访客，以便在工作区中的任何页面上进行非公开协作。如果你已经超过 5 位访客的限制，他们仍然可以访问被邀请到的页面。但是，如果你需要邀请更多访客，则需升级到个人专业版。</p><p>另外，我们的公开页面编辑功能可以让任何拥有页面链接的 Notion 用户对页面进行编辑或评论。</p>",
    "faq.whatHappensToFreeGuests.question": "我在旧免费计划中添加的访客会怎样？",
    "faq.whatIsABlock.answer": "<p>块是你添加到页面的任何单个内容，如文本段落、待办事项、图像、代码块、嵌入文件等。一个页面是由这些块来构建的。</p>",
    "faq.whatIsABlock.question": "什么是块？",
    "faq.whereStartupCredit.answer": "在 Notion 里面，进入“设置与成员”，然后点击“账单”。你会看到你当前的积分，包括“工作区余额”下的 US$1,000 积分。升级到团队计划后，它会显示在这里。",
    "faq.whereStartupCredit.question": "如何查看帐户中的积分余额？",
    "faq.whyBillingInformation.answer": "<p>即使你使用了足够的积分来支付第一笔帐单，我们仍需要你的付款信息，因为在将来积分用尽时，可保障你帐户可以正常续费。</p>",
    "faq.whyBillingInformation.question": "如果我有足够积分来支付 Notion，为什么还需要我的付款信息？",
    "faq.whyFreeForStudents.answer": "<p>Notion 是学校的完美工具。支持下一代思想家、梦想家和领导者，这是我们使命的核心。</p>",
    "faq.whyFreeForStudents.question": "为什么 Notion 对学生和教育工作者免费？",
    "faq.whyStartupDiscount.answer": "<p>我们已经看到数以千计的初创公司使用 Notion 迈出正确的一步——作为知识库，用于项目管理，文档共享，笔记等。我们希望帮助更多的公司从一开始就打下坚实的基础，并与他们一起成长。</p>",
    ...
    "fileUploadErrors.freePlanFileSizeExceeded.message": "你的文件超过免费计划的 5MB 限制。",
    "followPageButton.mobileFollowThisPage.button": "关注该页面",
    "followPageButton.mobileImageThumbnailCaption": "你将在侧边栏中收到更新，也可通过电子邮件获取更新摘要。",
    ...
    "frontPricingCard.annualBillingFinePrint": "显示的价格为年付价格。{br}请查看我们的<pricinglink>定价页面</pricinglink>了解月付价格。",
    ...
    "frontPricingCard.educationPlan.context.allPersonalPlanFeatures": "个人版的全部功能，以及",
    "frontPricingCard.enterprisePlan.attribute.advancedSecurity": "高级安全设置",
    "frontPricingCard.enterprisePlan.attribute.customContractInvoicing": "定制合同",
    "frontPricingCard.enterprisePlan.attribute.dedicatedManager": "专属客户经理",
    "frontPricingCard.enterprisePlan.attribute.samlSingleSignOn": "SAML 单点登录",
    "frontPricingCard.enterprisePlan.attribute.scimApi": "SCIM API",
    "frontPricingCard.enterprisePlan.attribute.sso": "SAML 单点登录",
    "frontPricingCard.enterprisePlan.context.allTeamPlanFeatures": "团队版的全部功能，以及",
    ...
    "frontPricingCard.evernotePremiumComparison.attribute.twoLevelHierarchy": "两级层次",
    ...
    "frontPricingCard.personalPlanComparison.oneliner": "整理你生活的每一个角落。",
    ...
    "frontPricingCard.startupPlan.context.allProPlanFeatures": "专业版的全部功能，以及",
    ...
    "frontPricingCard.teamPlan.context.allProPlanFeatures": "专业版的全部功能，以及",
    ...
    "frontSignupComponent.emailInput.genericEmailPlaceholder": "输入你的邮箱地址...",
    ...
    "fullPageError.accessNotAllowed.message": "你无权访问{workspaceName}。请与管理员联系以将你添加为成员。",
    "fullPageError.backToMyContentButton.label": "回到我的内容",
    "fullPageError.canRequestAccess.message": "如果有人批准你的请求，你则可以访问该页面。",
    "fullPageError.canRequestAccess.title": "无权访问该页面。",
    "fullPageError.cannotRequestAccess.message": "该页面不存在，或者你没有访问该页面的权限。",
    "fullPageError.contentDoesNotExist.message": "遇到麻烦？<helplink>给我们发送消息</helplink>",
    ...
    "fullPageError.offlineError.message": "哎呀，你好像离线了。请连接网络查看该页面。",
    "fullPageError.onboardingError.message": "你无权访问{workspaceName}。请与管理员联系以将你添加为成员。",
    "fullPageError.openInMobileAppButton.label": "在移动应用中开启",
    "fullPageError.pageIsPrivate.message": "这是{workspaceName}的私有页面。{hasOwner, select, true {请联系{ownerName}（ {ownerEmail} ）邀请你进行协作。}other{请与页面所有者联系以邀请你进行协作。}}",
    ...
    "fullPageError.sendMessageForHelp.message": "<sendmessagelink>给我们发送消息</sendmessagelink>寻求帮助。",
    ...
    "fullPageError.unsafePageError.message": "该页面可能包含垃圾邮件、网络钓鱼、非法或不当内容。如果你从未知来源收到此链接，建议你关闭此标签页。<proceedanywaylink>仍然继续</proceedanywaylink>",
    "fullPageError.unsafePageError.title": "该页面被标记为不安全",
    "fullPageError.whatIsNotionButton.label": "什么是 Notion？",
    "fullPageError.wrongAccount.message": "你可能需要使用其他邮箱地址<loginlink>登录</loginlink> ，或与页面所有者联系以请求访问。",
    ...
    "grantAccessActivityAction.alreadyHasAccess.label": "{requestingUser}已具有访问权限。",
    ...
    "guestPagesPopup.addAdminPermissionButton.tooltip": "该访客将成为该工作区的管理员。",
    ...
    "guestPagesPopup.removeGuestButton.tooltip": "该访客将从该工作区的所有页面中移除。",
    "guestPagesPopup.removeGuestModal.confirmationMessage": "确定要移除此人？他将无法访问所有已分享页面。",
    ...
    "helpButton.salesChatMessage": "你好！我想了解更多关于 Notion 企业版的信息。",
    "helpButton.sendMessage.menuItem": "向我们发送消息",
    "helpButton.sendUsAMessage.tooltip": "我们使用 Intercom 发送消息。{br}请确保它未被你的浏览器阻止。",
    ...
    "historyModal.unavailableForFreeWorkspaces.messagePart1": "版本历史不适用于免费工作区。",
    "historyModal.unavailableForFreeWorkspaces.messagePart2": "请升级至我们的付费计划。",
    "historyModal.upgradeForHistoryButton.label": "升级",
    "historyModal.upgradeToEnterprise.message": "请升级到企业版以访问 30 天以上的版本历史。",
    ...
    "inviteEmail.workspaceInviteMessage": "{name}邀请你加入{workspaceName} 工作区。",
    ...
    "inviteUserButton.modalTooltip.guestLimitLine1": "你的个人版最多可邀请 5 位不同的访客。",
    ...
    "invoice.chargeItem.changedNumberOfMembers.memberChange": "（从 {oldTotalMembers} 位到 {newTotalMembers} 位）",
    ...
    "invoice.chargeItems.proratedCharges.description": "由于上一个发票所涵盖的计费周期内发生的订阅更改而发生的一次调整。",
    ...
    "invoice.productName.enterprise": "{billingInterval, select, month {Notion 企业版月付计划} year {Notion 企业版年付计划} other {Notion 企业版}}",
    "invoice.productName.legacy": "{billingInterval, select, month {Notion 旧月付计划} year {Notion 旧年付计划} other {Notion 旧计划}}",
    "invoice.productName.personal": "{billingInterval, select, month {Notion 个人版月付计划} year {Notion 个人版年付计划} other {Notion 个人版}}",
    "invoice.productName.personalEducation": "{billingInterval, select, month {Notion 个人专业版（教育）月付计划} year {Notion 个人专业版（教育）年付计划} other {Notion 个人专业版（教育）}}",
    ...
    "invoiceErrors.invoiceNotFound.message": "你可能需要<loginlink>登录</loginlink>进行查看。",
    ...
    "localDatabase.erroMessages.noDiskSpaceRemainingBrowserLimit": "没有剩余的磁盘空间。你的浏览器设置可能限制了 Notion 可以使用的存储空间。",
    "localDatabase.errorFixes.chromeSettingsDamaged": "你的 Chrome 个人资料可能已损坏。如果你更改了 chrome:// flags，请重设它们，然后重新启动浏览器。如果问题仍然存在，请尝试创建新的 Chrome 用户。",
    "localDatabase.errorFixes.firefoxSettingsDamaged": "你的 Firefox 个人资料可能已损坏。访问 https://firefox-storage-test.glitch.me/ 进行诊断。",
    "localDatabase.errorFixes.helpAndSupportPrompt": "Notion 的本地存储可能损坏了。请参阅（？） > 帮助和支持 > 重置 Notion。",
    "localDatabase.errorFixes.reloadAllTabs": "尝试关闭并重新打开所有 Notion 的选项卡或窗口。",
    ...
    "loginActions.dialogError.logoutUnsavedChanges.message": "你尚未保存更改。如果你登出，它们将丢失。",
    ...
    "loginForm.disclaimer": "点击上方的“以谷歌 / 邮箱地址 / SAML 登录”，即表示你已经阅读并理解并同意 Notion 的<termsandconditionslink>条款和条件</termsandconditionslink>和<privacypolicylink>隐私政策</privacypolicylink>。",
    ...
    "loginForm.temporaryPasscodeSentMessageNoAccount": "此邮箱地址下没有现有帐户。我们刚刚向你发送了一个临时注册码。{br}请检查你的收件箱。",
    ...
    "loginPermissions.googleContactPermissions.message": "我们请求读取你的谷歌联系人，以便在邀请或提及人员时为你提供更好的体验。",
    ...
    "manageActiveSessions.logOutActiveSessions.label": "你将退出当前会话之外的所有其他活动会话，并且必须重新登录。",
    ...
    "moveBlockMenu.addToPrivatePages": "添加到<mediumtext>私人页面</mediumtext>",
    ...
    "moveBlockMenu.moveToPrivatePages": "移动到<mediumtext>私人页面</mediumtext>",
    ...
    "moveToOrCreateMenu.newPageIn.description": "在任何现有页面内创建一个新页面，然后一次性地链接到该页面。",
    ...
    "newBlock.equation.fuzzySearchKeywords": "LaTeX 数学 区块 方程式 公式 算式 等式 表达式 $$",
    ...
    "notificationSettings.desktopNotificationSettings.description": "通过你的桌面应用接收提及和评论的即时推送通知。",
    ...
    "notificationSettings.emailNotificationSettings.description": "通过电子邮件接收你关注的所有页面的提及、评论和编辑摘要。",
    ...
    "oauthAuthorizationPage.permissionStep.createSpaceLevelIntegrationCheckbox.label": "{workspaceName}与所有成员集成共享",
    ...
    "onboarding.desktopLogoutOption.text": "你当前以 {userEmail} 登录。{br}如果你不打算设置新帐户，可以使用<closelink>另一个邮箱地址登录。</closelink>",
    ...
    "onboardingGDPR.consentInfo.paragraph1.body": "我们使用 Cookie 来安全地识别你的帐户，让你保持登录状态，并改进我们的服务。",
    "onboardingGDPR.consentInfo.paragraph2.body": "我们透过行为数据分析来改进产品并解决客户的问题。其中包括 {intercomLink} 、 {amplitudeLink} 、 {segmentLink} 、 {snowflakeLink} 、 {crashlyticsLink}和{logglyLink}。我们将默认启用行为数据分析，因为它对我们的业务至关重要。",
    "onboardingGDPR.consentInfo.paragraph3.body": "你可以通过发送电子邮件至 {emailLink} 来撤销你对行为数据分析的许可。",
    "onboardingGDPR.consentInfo.paragraph4.body": "我们偶尔会发送产品更新和市场营销的电子邮件。每封电子邮件都会附上能让你立即退订的链接。",
    "onboardingGDPR.consentInfo.paragraph5.body": "请阅读我们的<termslink>服务条款与隐私政策</termslink>以获取更多信息。",
    ...
    "onboardingInvite.addEmail.placeholder": "输入或粘贴邮箱地址（支持多个，以“,”分隔）",
    ...
    "onboardingInvite.emailDomainAutoJoinCheckbox.label": "允许拥有 @{emailDomain} 邮箱地址的任何人加入该工作区",
    "onboardingInvite.emails.addAnotherButtonText": "添加其他电子邮件",
    "onboardingInvite.error.invalidEmailFound.message": "找到一个或多个无效邮箱地址。",
    ...
    "onboardingProfile.passwordGuidelines": "密码长度至少为 15 个字母，或者长度至少为 8 个字符且同时包含字母和数字。",
    ...
    "onboardingWorkspaceChoose.createSpaceOption.message": "或者 <nextlink>创建工作区</nextlink>",
    ...
    "onboardingWorkspaceCreate.initialUseCase.projectManagementLabel": "项目和任务",
    ...
    "onboardingWorkspacePlanChoose.personalUseCaseButton.callout": "单人使用免费",
    ...
    "onboardingWorkspacePlanChoose.teamUseCaseButton.description": "知识库、文档、任务和项目，都集在一处。",
    ...
    "onboardingWorkspaceUseCaseSetup.notesUseCaseButton.description": "捕捉想法，然后与团队分享。",
    "onboardingWorkspaceUseCaseSetup.notesUseCaseButton.label": "文档和笔记",
    "onboardingWorkspaceUseCaseSetup.notesUseCaseButtonPersonal.label": "笔记和整理",
    ...
    "onboardingWorkspaceUseCaseSetup.taskUseCaseButton.description": "直观地规划项目，并随时知道谁在做什么。",
    "onboardingWorkspaceUseCaseSetup.taskUseCaseButton.label": "项目和任务",
    "onboardingWorkspaceUseCaseSetup.taskUseCaseButtonPersonal.description": "在同个地方追踪所有待办事项和提醒。",
    ...
    "onboardingWorkspaceUseCaseSetup.wikiUseCaseButton.callout": "HTML 和 Markdown",
    "onboardingWorkspaceUseCaseSetup.wikiUseCaseButton.description": "你团队的长期记忆，全部集于一处。",
    "onboardingWorkspaceUseCaseSetup.wikiUseCaseButton.label": "团队知识库",
    "onboardingWorkspaceUseCaseSetup.wikiUseCaseButtonPersonal.description": "创建个人主页或网站，并与世界分享。",
    "onboardingWorkspaceUseCaseSetup.wikiUseCaseButtonPersonal.label": "网站和知识库",
    ...
    "pageOfflineIndicator.hasLocalData.message": "请连接网络后加载该页面，之后你便可以在离线时访问它。",
    "pageOfflineIndicator.noLocalData.message": "哎呀，你好像离线了。请连接网络后查看该页面。",
    "pagePermissionItem.allowComments.setting": "允许评论",
    "pagePermissionItem.allowComments.tooltip": "任何已登录的 Notion 用户都可以在该页面上发表评论。",
    "pagePermissionItem.allowDuplicateTemplate.setting": "允许制作副本",
    "pagePermissionItem.allowDuplicateTemplate.tooltip": "开启后，将允许其他用户创建公共页面的副本至他们的工作区。",
    "pagePermissionItem.allowEdits.setting": "允许编辑",
    "pagePermissionItem.allowEdits.tooltip": "任何已登录的 Notion 用户都可以编辑该页面。仅与你信任的人分享此秘密链接。",
    "pagePermissionItem.allowSearchEngine.tooltip": "如果允许，你的公共页面可能会出现在搜索引擎（如 Google）中，但仅当你或其他人在 Web 的其他地方链接到该网页时。",
    ...
    "pageViewBlock.templatePageBanner.editTemplateLabel": "正在编辑{pageTitleWithIcon}<mediumtext>的模板</mediumtext>",
    "pageViewBlock.templatePageBanner.learnMoreLink": "了解更多",
    "pageViewBlock.templatePageBanner.mobile.editTemplateLabel": "{pageTitleWithIcon}<mediumtext>中的模板</mediumtext>",
    ...
    "passwordChangeNotificationEmail.unintendedChange.message": "如果你没有进行此更改，请发送电子邮件至 team@makenotion.com 告知我们。去“我的帐户”设置中更改密码，或使用“忘记密码”重设密码。",
    ...
    "passwordSettings.educationPlanGuidelines": "如果你无法访问学校的邮箱地址，则可以使用密码登录。",
    ...
    "passwordSettings.passwordGuidelines": "密码长度至少为 15 个字母，或者长度至少为 8 个字符且同时包含字母和数字。",
    ...
    "passwordSettings.passwordSetInstructions": "如果你不想使用临时登录码，你可以设置永久密码。",
    ...
    "passwordSettings.removePasswordModal.educationPlanWarning": "如果你无法访问学校的邮箱地址，则将无法重新登录 Notion。",
    ...
    "passwordSettings.removePasswordModal.passwordInput.placeholder": "输入密码⋯",
    "passwordSettings.removePasswordModal.removePasswordButton.label": "移除密码",
    "passwordSettings.removePasswordModal.text": "你即将删除密码。我们会通过电子邮件将你的临时登录代码发送给你，以供日后访问 Notion。",
    ...
    "passwordSettings.setPasswordSuccess.educationMessage": "你的密码已全部设置好！即使无法访问学校的邮箱地址，你也能用密码登录。",
    ...
    "permissionRoleSelect.userEditorUpgradeTooltip.caption": "具有全部权限的访客可以编辑页面并与他人分享。",
    ...
    "permissions.confirmDialog.upgradeToTeamWorkspace.message": "若要将成员添加到工作区，你需要切换到团队版计划。将根据当前的计费间隔和账户余额按比例向你收取费用。",
    ...
    "pricingGrid.comparisonSection.adminAndSecurityFeatures.title": "管理员与安全性",
    ...
    "pricingGrid.footerSignupCallToAction.message": "免费注册。{br}随时邀请你的团队。",
    "pricingGrid.inTeamTrial": "免费试用中",
    "pricingGrid.inTeamTrial.tooltip": "你当前的团队试用版有 1,000 个块限制。升级以解除限制。",
    ...
    "pricingGrid.planAttribute.SSO.tooltip": "<p>通过安全的单点登录，自动化管理成员的访问权限。</p>",
    "pricingGrid.planAttribute.adminTools.title": "管理员工具",
    "pricingGrid.planAttribute.adminTools.tooltip": "<p>创建独立的管理员角色，以与成员权限区分。只有管理员可以邀请新成员、更改工作区设置。</p>",
    "pricingGrid.planAttribute.advancedPermissions.title": "高级权限",
    "pricingGrid.planAttribute.advancedPermissions.tooltip": "<p>设置更精细的权限，以限制受邀人员与他人分享页面。</p>",
    "pricingGrid.planAttribute.advancedSecurity.title": "高级安全控制",
    "pricingGrid.planAttribute.advancedSecurity.tooltip": "<p>解锁额外的权限控制，以防止特定人员向外部分享页面、禁用访客、并设置工作区安全规则。</p>",
    "pricingGrid.planAttribute.allPersonalPlanFeatures.tooltip": "<p>含个人版的所有功能，以及更多。</p>",
    "pricingGrid.planAttribute.allProPlanFeatures.tooltip": "<p>含个人专业版的所有功能，以及更多。</p>",
    "pricingGrid.planAttribute.allTeamPlanFeatures.tooltip": "<p>含团队版的所有功能，以及更多。</p>",
    "pricingGrid.planAttribute.apiAccess.title": "API 访问",
    "pricingGrid.planAttribute.apiAccess.tooltip": "<p>使用 Notion API 为你自己的工作流构建自定义集成。即将推出。</p>",
    "pricingGrid.planAttribute.apps.title": "Web、桌面和移动应用",
    "pricingGrid.planAttribute.apps.tooltip": "<p>Notion 可以在任何网页浏览器中运行，无需安装。你也可以下载我们的 Mac、Windows、iOS 或安卓应用。</p>",
    "pricingGrid.planAttribute.blockStorage.tooltip": "<p>块是你添加到页面上的内容组成部分，例如段落、待办事项、图片、嵌入式文件等。现在，所有定价计划的块都是无限的。团队试用版中的块存储上限为 1,000 个。</p>",
    "pricingGrid.planAttribute.blockTypes.title": "40 多种块内容类型",
    "pricingGrid.planAttribute.blockTypes.tooltip": "<p>块是你添加到页面上的一块内容，比如待办事项，图片，代码，文件。</p> <p>块还可以帮助你嵌入来自谷歌云端硬盘、GitHub、Twitter 和 Typeform 等第三方服务的内容。</p>",
    "pricingGrid.planAttribute.blocks.title": "页面和块",
    "pricingGrid.planAttribute.bulkExport.title": "批量导出",
    "pricingGrid.planAttribute.bulkExport.tooltip": "<p>你的数据是你的。你可以将所有页面导出为 HTML、Markdown 或 CSV（用于数据库），以及你上传的任何文件和图片。</p>",
    "pricingGrid.planAttribute.bulkPDFExport.title": "批量 PDF 导出",
    "pricingGrid.planAttribute.bulkPDFExport.tooltip": "<p>将所有内容导出为 PDF，方便进行法律或合规性备份。</p>",
    "pricingGrid.planAttribute.button.upgrade": "升级",
    "pricingGrid.planAttribute.collaborativeWorkspace.title": "协作工作区",
    "pricingGrid.planAttribute.collaborativeWorkspace.tooltip": "<p>协作工作区让成员轻松分享页面给整个团队，让整个团队统一内容结构，并支持精细的权限设置。</p>",
    "pricingGrid.planAttribute.contentApi.title": "内容 API",
    "pricingGrid.planAttribute.contentApi.title.v2": "API",
    "pricingGrid.planAttribute.contentApi.tooltip": "<p>访问 Notion 内容 API 以构建基于你自己的工作流的自定义集成。即将推出。</p>",
    ...
    "pricingGrid.planAttribute.customContract.tooltip": "<p>我们将为你定制合同，并通过 PO/发票付款。</p>",
    "pricingGrid.planAttribute.databaseProperties.tooltip": "<p>构建具有丰富属性的强大数据库，例如复选框、下拉菜单、货币、指派人员、日期和文件等。</p>",
    "pricingGrid.planAttribute.databaseViews.title": "表格、列表、日历、看板和画廊视图",
    "pricingGrid.planAttribute.databases.title": "具有多元属性类型的数据库",
    "pricingGrid.planAttribute.databases.tooltip": "<p>数据库支持多种视图，可以选择最适合自己工作流的可视化方式。数据库可以用来做项目看版、事件日历等。</p>",
    "pricingGrid.planAttribute.dedicatedManager.title": "专属客户经理",
    "pricingGrid.planAttribute.dedicatedManager.tooltip": "<p>适用于超过 100 人的年付团队。</p>",
    "pricingGrid.planAttribute.earlyAccess.title": "提前使用新功能",
    "pricingGrid.planAttribute.earlyAccess.tooltip": "<p>提前体验特权意味着你将永远拥有最新、功能最强大的 Notion 版本。你还将直接影响我们未来的产品路线图。</p>",
    "pricingGrid.planAttribute.evernoteHierarchy.tooltip": "<p>将笔记组织到笔记本或堆叠中。</p>",
    "pricingGrid.planAttribute.fileUploads.title": "文件上传",
    "pricingGrid.planAttribute.fileUploads.tooltip": "<p>上传到 Notion 的单一文件大小限制。</p>",
    "pricingGrid.planAttribute.fileUploads.trial.5MbFileUploadLimit": "试用版 5 MB",
    "pricingGrid.planAttribute.fileUploads.value.5MbFileUploadLimit": "5 MB",
    "pricingGrid.planAttribute.freeForIndividuals.tooltip": "<p>现在个人使用 Notion 永久免费。</p>",
    "pricingGrid.planAttribute.genericNotes.tooltip": "<p>创建文档，并与他人分享。</p>",
    "pricingGrid.planAttribute.genericReminders.tooltip": "<p>收到截止日期的提醒。</p>",
    "pricingGrid.planAttribute.genericTags.tooltip": "<p>记录并组织你的笔记。</p>",
    "pricingGrid.planAttribute.genericWebClipper.tooltip": "<p>保存网络上的任何页面。</p>",
    "pricingGrid.planAttribute.guests.title": "访客",
    "pricingGrid.planAttribute.guests.tooltip": "<p>访客是工作区成员之外的个人，例如朋友、家人、承包商或客户。通过邀请访客在特定页面上进行非公开协作。</p>",
    "pricingGrid.planAttribute.linkSharing.title": "链接共享",
    "pricingGrid.planAttribute.linkSharing.tooltip": "<p>与任何人分享一个秘密链接，以便他们查看，评论或编辑你的页面。</p>",
    "pricingGrid.planAttribute.members.title": "成员",
    "pricingGrid.planAttribute.members.tooltip": "<p>成员是你邀请加入工作区的队友。他们可以访问并添加页面供所有成员查看，或者被添加到具有私人协作权限的页面。</p>",
    "pricingGrid.planAttribute.notInTrial": "不在试用版中",
    "pricingGrid.planAttribute.notionCollaboration.tooltip": "<p>与其他人在同一个页面上一起工作。</p>",
    "pricingGrid.planAttribute.notionDatabases.tooltip": "<p>用数据库视图、汇总、筛选器等工具搭建新的工作流。</p>",
    "pricingGrid.planAttribute.notionHierarchy.tooltip": "<p>页面可以无限层级、无限嵌套。</p>",
    "pricingGrid.planAttribute.notionMarkdown.tooltip": "<p>用 Markdown 书写或导出内容。</p>",
    "pricingGrid.planAttribute.permissionGroups.title": "权限群组",
    "pricingGrid.planAttribute.permissionGroups.tooltip": "<p>为不同的群组和团队设置不同等级及精细度的权限。</p>",
    "pricingGrid.planAttribute.prioritySupport.title": "优先支持",
    "pricingGrid.planAttribute.prioritySupport.tooltip": "<p>我们随时为你提供帮助。</p>",
    "pricingGrid.planAttribute.proWebPublishing.tooltip": "<p>将 Notion 页面作为独立网站发布。即将推出。</p>",
    "pricingGrid.planAttribute.realTimeCollaboration.title": "实时协作",
    "pricingGrid.planAttribute.realTimeCollaboration.tooltip": "<p>实时与他人合作，可显示在线状态和评论。</p>",
    "pricingGrid.planAttribute.scimApi.title": "SCIM API",
    "pricingGrid.planAttribute.scimApi.tooltip": "<p>访问 Notion SCIM API 以配置和管理用户和群组。</p>",
    "pricingGrid.planAttribute.sso.title": "SAML 和单点登录（SSO）",
    "pricingGrid.planAttribute.templates.title": "50 多个入门模板",
    "pricingGrid.planAttribute.templates.tooltip": "<p>你可以从一张白纸开始，也可以直接从经过专业设计的模板库中挑选模板。</p> <p>一些模板包括：笔记、目标管理、公司首页、会议纪要、产品路线图、员工入职手册和工程知识库。</p>",
    "pricingGrid.planAttribute.timeline.tooltip": "<p>使用时间轴视图进行项目排程和规划。</p>",
    ...
    "pricingGrid.planAttribute.versionHistory.tooltip": "<p>查看和恢复任何页面的历史版本。</p>",
    "pricingGrid.planAttribute.versionHistory.value.30DaysSavedHistory": "30 天",
    "pricingGrid.planAttribute.versionHistory.value.foreverSavedHistory": "永久",
    "pricingGrid.planAttribute.versionHistory.value.notInTrial": "不在试用版中",
    "pricingGrid.planAttribute.versionHistory.value.trialUpgradeLabel": "升级到 30 天历史记录",
    "pricingGrid.planAttribute.wikiDocsNotes.title": "知识库、文档和笔记",
    "pricingGrid.planAttribute.wikisDocsNotes.tooltip": "<p>用 Notion 构建共享知识库、文档、数据库、或将其作为强大的笔记工具。</p>",
    ...
    "pricingGrid.switchPlanAsMember.tooltip": "需要成为该工作区的管理员才能切换计划。",
    "pricingGrid.switchPlanFromInAppPurchase.tooltip": "目前正在通过Apple的App内购买订阅。要改变计划，请先取消Apple订阅。",
    "pricingGrid.switchToPersonalPlanButton.tooltip": "个人版和个人专业版仅供 1 人使用。如果你想使用这些计划，请移除当前工作区中的其他成员。",
    ...
    "profileSettings.changeEmailModal.newEmailInput.placeholder": "输入新的邮箱地址",
    ...
    "profileSettings.changeEmailModal.sendVerificationCodeToCurrentEmail": "我们将向该邮箱地址发送临时验证码。",
    "profileSettings.changeEmailModal.sentVerificationCodeToCurrentEmail": "我们已向该邮箱地址发送了临时验证码。",
    "profileSettings.changeEmailModal.verificationCodeSentMessage": "我们刚刚向你的帐户 {newEmail} 发送了一个临时验证码 。",
    "profileSettings.dangerousSettings.deleteAccountButton.label": "删除我的帐户",
    ...
    "pushNotification.userDeletedBlockInSpace.message": "{userName}删除了{spaceName}的{targetName}",
    "pushNotification.userDeletedRowInCollection.message": "{userName}在{collectionName}删除了{targetName}",
    ...
    "pushNotifications.collectionDescriptionAdded.notificationSubject": "{userName}为{collectionName}新增了描述",
    ...
    "queueApiErrors.duplicateBlockLimit.errorMessage": "糟糕，内容太多了！你当前的计划限制你只能创建 {blockLimitNumber} 个块副本。请使用较少的内容重试。",
    ...
    "referralActivatedEmail.howToEarnCreditList.item.installWebClipper": "为 Chrome 安装<webclipperlink> Notion 网页剪裁器</webclipperlink>。",
    "referralActivatedEmail.howToEarnCreditList.item.keepInviting": "多多<referlink>邀请</referlink>朋友和同事。",
    "referralActivatedEmail.notionTeamSignoffAndThanks": "感谢你将 Notion 告诉亲朋好友，{br} — Notion 团队",
    "referralActivatedEmail.rewardMessage": "你的帐户已赚取<b> {creditValue} 的积分</b>！可以使用积分来<upgradelink>升级</upgradelink>并完全利用 Notion 的所有强大功能。{br}{br}想要<upgradelink>赚取更多的积分</upgradelink>吗？可以通过以下几种方法：",
    "referralActivatedEmail.signupText": "收到你的邀请后，有人注册了 Notion 帐户。",
    "referralActivatedEmail.subjectLine": "{creditValue}积分即将到帐！",
    "referralEmail.creditInfo.text": "注册后，我们会将<b> {creditDollarAmount} </b>放入你的帐户。可以用它来升级并发现 Notion 提供的所有强大功能。",
    "referralEmail.invitedIntro.text": "<b> {fromUserName} </b> ({fromUserEmail}) 邀请你加入 Notion！ {br}{br} Notion 是一种多合一的信息工具，帮助你保持生活和工作井井有条。在我们的<referlink>网站</referlink>上可以了解更多相关信息。",
    "referralEmail.signupPrompt": "<b> <signuplink>点击此处注册并赚取 {creditDollarAmount} 积分</signuplink> </b>",
    ...
    "removeUsersFromSpace.removingLastAdmin.error.message": "无法删除最后一个管理员。",
    ...
    "restrictedPermissionConfirmationModal.remove.description": "确定要更改此角色并限制访问吗？该页面将不再继承父页面的分享设置。",
    ...
    "restrictedPermissionConfirmationModal.restrict.description": "确定要删除此{permissionGroup}并限制访问权限吗？该页面将不再继承父页面的分享设置。",
    ...
    "router.renderErrorPage.message.part2": "请刷新并重试，或者<textlink>给我们发送消息</textlink>。",
    ...
    "samlErrors.emailDomainAlreadyConfigured.message": "该邮件域名已在下列工作区设置过 SAML: {workspace}",
    "samlErrors.emailNotCofiguredForSamlSso.message": "该邮箱地址尚未配置此工作区的 SAML SSO。请联系你的管理员。",
    ...
    "samlErrors.incorrectlyConfiguredSaml.message": "SAML SSO 配置错误。请联系你的管理员。",
    ...
    "saveEditsError.mobile.message": "保存编辑时存在问题。请给我们发消息寻求帮助。",
    ...
    "search.recentMenuItem.createdDateBefore.subtitle": "创建于 {startDate}之前",
    "search.recentMenuItem.createdDateWithRange.subtitle": "创建于 {startDate}至 {endDate}",
    "search.recentMenuItem.lastEditedDateAfter.subtitle": "上次编辑于 {startDate}之后",
    "search.recentMenuItem.lastEditedDateBefore.subtitle": "上次编辑于 {endDate}之前",
    "search.recentMenuItem.lastEditedDateWithRange.subtitle": "上次编辑于 {startDate}至 {endDate}",
    ...
    "searchFooter.helpText.resultCount": "{resultCount, plural, other {<resultwrapper>{resultCount}</resultwrapper> 个结果}}",
    "searchFooter.helpText.resultCountApproximate": "{resultCount, plural, other {<resultwrapper>{resultCount}+</resultwrapper> 个结果}}",
    ...
    "securitySAMLSettings.SAMLSection.uneditableMessage": "SAML 正在由工作区<bold>{workspaceName}</bold>管理。请到那里更改相关 SAML 设置。",
    "securitySAMLSettings.SAMLSingleSignOnSection.automaticallyCreateAccounts.caption": "允许用户创建 Notion 帐户，而无需从 IDP 配置。",
    "securitySAMLSettings.SAMLSingleSignOnSection.automaticallyCreateAccounts.label": "登录时自动创建帐户",
    "securitySAMLSettings.SAMLSingleSignOnSection.enableSAML.caption": "这将允许用户使用已配置的域名上的邮箱地址通过 SAML 登录。SAML 身份验证可以在下面强制执行。",
    "securitySAMLSettings.SAMLSingleSignOnSection.enableSAML.label": "启用 SAML",
    "securitySAMLSettings.SAMLSingleSignOnSection.enableSAML.tooltip": "SAML 完全配置后方可启用。",
    "securitySAMLSettings.SAMLSingleSignOnSection.enforceSAML.captionMulti": "强制执行后，在上面配置的电子邮件域名中到工作区成员只能使用 SAML SSO 登录。管理员帐户仍可以使用电子邮件登录。",
    "securitySAMLSettings.SAMLSingleSignOnSection.enforceSAML.label": "强制使用 SAML",
    "securitySAMLSettings.SAMLSingleSignOnSection.enforceSAML.tooltip": "启用 SAML 后变更此选项。",
    "securitySAMLSettings.SAMLSingleSignOnSection.singleSignOnURLSettings.IdentityProviderMetadataURLOption.label": "IDP 元数据 URL",
    "securitySAMLSettings.SAMLSingleSignOnSection.singleSignOnURLSettings.IdentityProviderMetadataXMLOption.caption": "输入你的身份提供商（IDP）提供的值。",
    "securitySAMLSettings.SAMLSingleSignOnSection.singleSignOnURLSettings.IdentityProviderMetadataXMLOption.input.placeholder": "IDP 元数据 XML",
    "securitySAMLSettings.SAMLSingleSignOnSection.singleSignOnURLSettings.IdentityProviderMetadataXMLOption.label": "IDP 元数据 XML",
    "securitySAMLSettings.SAMLSingleSignOnSection.singleSignOnURLSettings.title": "单点登录 URL",
    "securitySAMLSettings.SAMLSingleSignOnSection.singleSignOnURLSettings.url.caption": "在身份提供商的 SAML 配置中输入此内容。",
    ...
    "securitySAMLSettings.SCIMSection.contactUs": "要生成 SCIM AP I令牌，请<contactlink>联系支持</contactlink>。",
    "securitySAMLSettings.SCIMSection.helpButton.label": "了解 SCIM",
    "securitySAMLSettings.SCIMSection.revokeToken.label": "撤销令牌",
    "securitySAMLSettings.SCIMSection.revokeTokenModal.acceptButton.label": "撤销 SCIM 令牌",
    "securitySAMLSettings.SCIMSection.revokeTokenModal.cancelButton.label": "取消",
    "securitySAMLSettings.SCIMSection.revokeTokenModal.message": "撤销 SCIM 令牌？使用此令牌的所有 SCIM API 请求将不再成功。",
    "securitySAMLSettings.SCIMSection.title": "SCIM 配置",
    "securitySAMLSettings.SCIMSection.tokenRevoked.message": "成功吊销 SCIM 令牌。新令牌已可用。",
    ...
    "securitySAMLSettings.disableGuests.confirmationModal.message": "是否确定？该工作区中的所有访客都将被移除。",
    "securitySAMLSettings.emailDomainsSection.emailInput.caption": "启用 SAML 后，任何具有以下域名的邮箱地址的都可以使用 SAML SSO 登录。<contactlink>联系客服</contactlink>以添加或删除域。",
    "securitySAMLSettings.emailDomainsSection.emailInput.placeholder": "未配置电子邮件域名",
    ...
    "securitySAMLSettings.securitySection.disableExport.caption": "这将禁止任何人导出为 Markdown、CSV 或 PDF。",
    "securitySAMLSettings.securitySection.disableExport.label": "禁用导出",
    "securitySAMLSettings.securitySection.disableGuests.caption": "这将禁止任何人邀请工作区之外的人访问任何页面。",
    "securitySAMLSettings.securitySection.disableGuests.label": "禁用访客",
    "securitySAMLSettings.securitySection.disableMovingPages.caption": "这将禁止任何人通过“移动到”或“保存副本到”操作将页面移动或保存副本到其他工作区。",
    ...
    "securitySAMLSettings.securitySection.disableSpacePageEdits.caption": "这将使成员无法创建、移动、重新排序和删除顶层工作区页面。",
    "securitySAMLSettings.securitySection.disableSpacePageEdits.label": "防止成员更改侧边栏的工作区部分",
    "securitySAMLSettings.securitySection.preventPublicSharing.caption": "这将禁用该工作区中每个页面上“分享”菜单中的“分享到网络”选项。",
    "securitySAMLSettings.securitySection.preventPublicSharing.label": "防止成员公开分享页面",
    "securitySAMLSettings.securitySection.title": "安全",
    "securitySAMLSettings.spaceNamesSection.spaceNameInput.caption": "此处的 SAML 设置适用于多个工作区。<contactlink>联系支持人员</contactlink>来添加或删除工作区。",
    "securitySAMLSettings.spaceNamesSection.title": "工作区",
    "securitySAMLSettings.updateButton.label": "更新",
    "securitySAMLSettings.upsell.caption": "升级到企业版即可获得高级安全设置、SAML 单点登录以及自动用户和群组配置。",
    ...
    "sendMobileAppLink.textMessage": "你好！点击此链接可在手机上安装 Notion： {baseURL}/mobile?download=true 不要忘了下载我们的 Mac 和 Windows 应用。祝使用愉快！",
    ...
    "sidebar.myPagesSection.tooltip": "你创建的私人或私有分享页面。只有你特定邀请工作区成员，他们才能访问。",
    ...
    "sidebarActions.confirmDialog.lockedWorkspaceTopLevel.message": "该工作区已锁定工作区顶层页面的动作。",
    "sidebarActions.confirmDialog.movePageToPrivate.confirmButton.label": "移动到私人区",
    "sidebarActions.confirmDialog.movePageToPrivate.message": "确定要将该页面设为私有吗？ <boldtext>只有你将能够访问它。</boldtext>",
    "sidebarActions.confirmDialog.moveWorkspacePage.confirmButton.label": "移动页面",
    "sidebarActions.confirmDialog.moveWorkspacePage.message": "确定要移动该工作区页面？<boldtext>所有 {memberCount} 位成员都可以看到</boldtext>",
    "sidebarActions.confirmDialog.newWorkspacePage.confirmButton.label": "创建顶层页面",
    "sidebarActions.confirmDialog.newWorkspacePage.message": "确定要创建一个顶层页面吗？ <strongtext>该页面将在所有 {memberCount} 位成员的工作区边栏中可见。</strongtext>",
    "sidebarActions.confirmDialog.reorderWorkspaceSidebar.confirmButton.label": "重新排序侧边栏",
    "sidebarActions.confirmDialog.reorderWorkspaceSidebar.message": "确定要对工作区边栏重新排序吗？ <boldtext>这将影响所有 {memberCount} 位成员。</boldtext>",
    "sidebarActions.confirmDialog.sharePageWithWorkspace.confirmButton.label": "移动到工作区",
    "sidebarActions.confirmDialog.sharePageWithWorkspace.message": "确定与工作区分享该页面吗？<boldtext>所有 {memberCount} 位成员都将可以访问。</boldtext>",
    "sidebarCredits.earnedCredit.message": "你已赚取 {creditAmountInDollars} 的积分。",
    "sidebarCredits.freeMonthMessage": "{numberOfMonths, plural, other {等同于 <b>{numberOfMonths} 个月</b>免费。}}",
    ...
    "sidebarStudentPlanPrompt.eligible.message": "你有资格获取免费个人专业版（教育）计划。",
    ...
    "sidebarSwitcher.workspaceSubtitleWithMembers.label": "{planType}・{numberOfWorkspaceMembers} 位成员",
    ...
    "slackIntegrationButton.removeIntegrationConfirmationDialog.prompt": "确定要删除 Slack 集成吗？",
    ...
    "slackNotification.welcomeMessage": "欢迎来到 Notion！该频道已与 Notion 的页面绑定成功 {pageLink}。你将获取有关该页面或页面内的评论、提及和编辑的更新动态。",
    "slackNotifications.blockCreated.notificationContents": "{userName}在{blockName}中创建了{blockName} {workspaceName}",
    ...
    "slackNotifications.collectionRowCreated.notificationContents": "{userName}在{collectionName}创建了{rowName} {collectionName}",
    ...
    "spaceActions.dialogError.createOrUpdatePermissionGroup.invalidWorkspaceStorage.message": "没有有关该工作区的本地数据。",
    ...
    "spaceBasicSettings.PublicHomePageSection.input.placeholder": "选择Web上共享的页面",
    ...
    "spaceBasicSettings.allowedEmailDomainsSection.emailDomainsDropdown.placeholderNoResults": "输入该工作区成员的电子邮件域名⋯",
    ...
    "spaceBasicSettings.domainSection.workspaceDomainInput.caption": "分享链接 {linkText} 以添加任何在邮箱地址域名白名单里的人到你的工作区。",
    "spaceBasicSettings.domainSection.workspaceDomainInput.joinWorkspace.caption": "如果有允许的电子邮件域，任何人都可以通过{linkText}链接订阅此工作空间。",
    "spaceBasicSettings.domainSection.workspaceDomainInput.placeholder": "URL",
    "spaceBasicSettings.domainSection.workspaceDomainInput.viewPublicPage.caption": "您可以在{linkText}上找到在网络上共享的页面。",
    ...
    "spaceBasicSettings.leaveWorkspaceConfirmationDialog.prompt": "确定要离开该工作区？",
    "spaceBasicSettings.membersTab.manageMembersWithLinkCaption": "在这里管理成员。",
    "spaceBasicSettings.membersTab.manageMembersWithoutLinkCaption": "在这里管理成员，或<setupdomainlink>设置域名</setupdomainlink>以便具有该域名内邮箱地址的每个人都可以自动加入当前工作区。",
    ...
    "spaceBasicSettings.workspaceNameSection.nameInput.caption": "你可以使用你的名字或团队的名字。保持简单。",
    ...
    "spacePermissionSettings.memberUpsell.alternativeUpgradeLabel": "升级到团队版",
    "spacePermissionSettings.memberUpsell.caption": "免费试用 Notion 团队版 — 更适合多人协作的工作区、无限成员以及高级权限设置。",
    "spacePermissionSettings.memberUpsell.title": "与无限成员分享",
    "spacePermissionSettings.spaceMembers.inviteLink.caption": "分享这个私密链接以邀请他人加入到工作区。仅管理员可见。",
    "spacePermissionSettings.spaceMembers.inviteLink.resetLink": "你可以<resetlink>重置</resetlink>以生成新的邀请链接。",
    "spacePermissionSettingsTrialModal.cancel.label": "取消",
    "spacePermissionSettingsTrialModal.tryItFree.label": "免费试用",
    "spacePermissionsSettings.groupsTab.adminsOnly": "只有管理员可以添加权限群组。",
    ...
    "spacePermissionsSettings.groupsTab.deleteGroupModal.confirmationMessage": "确定要删除该群组吗？该群组的所有私人页面都将转移给你。",
    "spacePermissionsSettings.groupsTab.filterGroupsInput.placeholder": "按邮箱地址或姓名筛选⋯",
    ...
    "spacePermissionsSettings.groupsTab.upgradeCaption": "升级到团队版以从“分享”菜单设置群组并控制权限。",
    "spacePermissionsSettings.groupsTab.upgradeMessage": "升级到团队版或企业版以使用权限群组。",
    "spacePermissionsSettings.groupsTab.upgradeMessageWithLink": "<upgradelink>升级到团队版或企业版</upgradelink>以使用权限群组。",
    ...
    "spacePermissionsSettings.inviteLinkRefreshModal.description": "确定要重置邀请链接？旧的链接将无法再使用。",
    ...
    "spaceSubscriptionBilling.changeBillingAddressModal.addressLine1Input.label": "地址第一行",
    "spaceSubscriptionBilling.changeBillingAddressModal.addressLine2Input.label": "地址第二行",
    "spaceSubscriptionBilling.changeBillingAddressModal.businessNameInput.label": "商业名称",
    "spaceSubscriptionBilling.changeBillingAddressModal.cancelButton.label": "取消",
    "spaceSubscriptionBilling.changeBillingAddressModal.cityInput.label": "城市",
    "spaceSubscriptionBilling.changeBillingAddressModal.countryInput.label": "国家或地区",
    "spaceSubscriptionBilling.changeBillingAddressModal.nameInput.label": "名称",
    "spaceSubscriptionBilling.changeBillingAddressModal.stateInput.label": "州或省",
    ...
    "spaceSubscriptionBilling.changeBillingEmailModal.title": "更改账单邮箱地址",
    "spaceSubscriptionBilling.changeBillingInterval.helpButton.label": "了解此设置将如何影响你的帳单。",
    ...
    "spaceSubscriptionBilling.invoicesSection.loadMoreInvoicesButton.label": "加载更多",
    "spaceSubscriptionBilling.invoicesSection.noInvoicesMessage": "该工作区尚未付款。",
    ...
    "spaceSubscriptionBilling.setBillingInterval.enterprisePlan.monthlyBilling.unavailable": "企业版不适用",
    "spaceSubscriptionBilling.setBillingInterval.monthlyOption": "月付",
    "spaceSubscriptionBilling.setBillingInterval.pricePerMonth": "每月 {monthlyPrice}",
    "spaceSubscriptionBilling.setBillingInterval.pricePerMonth.perMember": "每人每月 {monthlyPrice}",
    "spaceSubscriptionBilling.setBillingInterval.yearlyOption": "年付・可节省 {yearlySavingsPercent}",
    "spaceSubscriptionBilling.setPaymentMethod.achOrWireTransferOption": "ACH 或电汇",
    "spaceSubscriptionBilling.setPaymentMethod.achOrWireTransferOption.description": "通过电子邮件接收发票",
    ...
    "spaceSubscriptionBilling.subscriptionSettingsSection.VATID.title": "VAT ID",
    "spaceSubscriptionBilling.subscriptionSettingsSection.applyCoupon.title": "使用优惠券",
    "spaceSubscriptionBilling.subscriptionSettingsSection.billingAddress.title": "账单地址",
    "spaceSubscriptionBilling.subscriptionSettingsSection.billingEmail.title": "账单邮箱地址",
    "spaceSubscriptionBilling.subscriptionSettingsSection.billingInterval.title": "账单间隔",
    ...
    "spaceSubscriptionBilling.subscriptionSettingsSection.enterprisePlanTitle": "企业版",
    "spaceSubscriptionBilling.subscriptionSettingsSection.legacyPlanTitle": "旧计划",
    ...
    "spaceSubscriptionBilling.subscriptionSettingsSection.paymentMethod.value.creditCard": "尾数为 {lastFourDigits} 的 {creditCardBrand} 卡",
    "spaceSubscriptionBilling.subscriptionSettingsSection.paymentMethod.value.none": "无",
    "spaceSubscriptionBilling.subscriptionSettingsSection.personalEducationPlanTitle": "个人专业版（教育）",
    "spaceSubscriptionBilling.subscriptionSettingsSection.personalPlanTitle": "个人专业版",
    "spaceSubscriptionBilling.subscriptionSettingsSection.restartSubscriptionButton.label": "重新订阅",
    "spaceSubscriptionBilling.subscriptionSettingsSection.teamPlanTitle": "团队版",
    ...
    "spaceSubscriptionBilling.upgradeModal.creditSection.notionCredit.description": "Notion 积分",
    "spaceSubscriptionBilling.upgradeModal.creditSection.promotion.description": "优惠",
    ...
    "spaceSubscriptionBilling.useCreditModal.amountOfCreditQuestion": "你想在下一张发票使用多少积分？",
    "spaceSubscriptionBilling.useCreditModal.applyCreditButton.label": "使用积分",
    ...
    "spaceSubscriptionBilling.useCreditModal.title": "使用 Notion 积分・{creditInDollars} 可用",
    "spaceSubscriptionBilling.useCreditModal.warning": "使用积分到你的帐户后<bold>不能撤消</bold>。",
    ...
    "spaceSubscriptionPlans.priceDisclaimer": "显示的为年付计划价格。若选择月付计划，<b>个人专业版计划</b>为每月 {personalMonthlyPrice}，<b>团队版计划</b>为每位成员每月 {teamMonthlyPrice}，而<b>企业版计划</b>为每位成员每月 {enterpriseMonthlyPrice}。",
    "spaceSubscriptionPlans.studentsAndEducatorsSection.getEducationPlanButton.label": "获取免费教育计划",
    "spaceSubscriptionPlans.studentsAndEducatorsSection.text": "<p>个人专业版计划对学生和教育工作者是免费的！只需使用你的学校的邮箱地址注册即可立即使用这些功能。</p><p>如果你已经在使用个人专业版，请将与你帐户关联的电子邮件更改为学校的邮箱地址以免费获取。</p>",
    "spaceSubscriptionPlans.studentsAndEducatorsSection.title": "学生与教育工作者",
    "spaceSubscriptionPlans.teamPlan.confirmButtonLabel": "{upgrading, select, true {升级到团队版} other {降级到团队版}}",
    "spaceSubscriptionPlans.teamPlan.confirmMessage": "系统会根据你当前的结算间隔和帐户余额按比例向你收取费用。",
    "spaceSubscriptionSettings.upgradeMenu.paymentExplanation": "注意：我们仍然需要你的付款信息，以防你的积分在下一个账单周期内用完。我们将于扣款日的 7 天前向你发送电子邮件。",
    "spaceSubscriptionSettings.upgradeModal.billingIntervalSection.header": "开单周期",
    "spaceSubscriptionSettings.upgradeModal.billingIntervalSection.title": "账单间隔",
    "spaceSubscriptionSettings.upgradeModal.cancelButton.label": "取消",
    "spaceSubscriptionSettings.upgradeModal.chargeSummary.creditsAdjustment": "我们还从你的账单中扣除了 <bold>{creditAmountInDollars} 的积分</bold>。",
    "spaceSubscriptionSettings.upgradeModal.chargeSummary.creditsAndBalanceAdjustment": "我们还从你的账单中扣除了 <bold>{creditAmountInDollars} 的积分</bold>和 <bold>{accountBalanceInDollars} 的工作区余额</bold>。",
    "spaceSubscriptionSettings.upgradeModal.chargeSummary.personalPlan": "{billedYearly, select, true {你将支付<bold>每月 {chargeAmount}</bold>，共计 <bold>12 个月</bold>。} other {你将<bold>每个月支付 {chargeAmount}</bold>。}}",
    "spaceSubscriptionSettings.upgradeModal.chargeSummary.teamPlan": "{billedYearly, select, true {你将为 {pluralizedMembers}支付<bold>每人每月 {chargeAmount}</bold>，共计 <bold>12 个月</bold>。} other {你将每个月为 {pluralizedMembers}支付<bold>每人 {chargeAmount}</bold>。}}",
    "spaceSubscriptionSettings.upgradeModal.chargeSummary.workspaceBalanceAdjustment": "我们还从你的账单中扣除了 <bold>{accountBalanceInDollars} 的工作区余额</bold>。",
    ...
    "spaceSubscriptionSettings.upgradeModal.memberPluralForm": "{memberCount, plural, other {{memberCount} 位成员}}",
    ...
    "spaceSubscriptionSettings.upgradeModal.titleWithWorkspaceName": "为{spaceName}订阅{planName}",
    "spaceSubscriptionSettings.upgradeModal.titleWithoutWorkspaceName": "为工作区订阅{planName}",
    ...
    "spaceSubscriptionUpgradeMenu.checkEmailDialog.message": "请检查你的电子邮件以获取发票。",
    "spaceSubscriptionUpgradeMenu.creditLeftover.message": "你目前使用的积分超过了所需要的数量，因此我们会将差额（{creditAmountLeft}）用作你以后的账单的帐户余额。",
    ...
    "spaceSubscriptionUpgradePlanFeatures.blockLimit.tooltip": "块是你添加到页面的内容，例如文本段落或待办事项。{br}团队试用版不提供付费团队版中的某些功能。",
    ...
    "studentNotEligibleModal.header": "<p>你当前使用的邮箱地址没有资格享受免费的个人专业版计划。</p><p>K-12 学生、K-12 教育工作者以及使用 Gmail、Outlook 等个人邮箱地址的用户没有资格免费获取<pricinglink>个人专业版计划</pricinglink>，但任何人都可以使用免费的<pricinglink>个人版计划</pricinglink>享受无限存储空间。</p>",
    ...
    "studentNotEligibleModal.numberedList.item2.promocodePlaceholder": "输入教育优惠码⋯",
    ...
    "subscriptionActions.overFreeBlockLimit.longMessage": "你已超过免费计划的块限制",
    ...
    "subscriptionHelpers.billingInterval.yearly.title": "<pre>年付・<span>省 {yearlySavingsPercent}</span></pre>",
    ...
    "subscriptionSettings.freePersonal.downgradeConfirmationButton": "降级到个人版",
    "subscriptionSettings.freePersonal.downgradeMessage": "个人版仅供1人免费使用。你将失去添加成员的能力，并且每个工作区的访客将限制为 5 个。",
    ...
    "subscriptionSettings.personalFreeMessage": "你现在免费订阅了 Notion 的个人专业计划。",
    "subscriptionSettings.startTeamTrialDialog.confirmationbutton": "开始团队版试用",
    "subscriptionSettings.subscriptionNextChargeMessage.enterprisePlan": "{planInterval, select, month {该工作区的企业版计划已设定为<bold>每月 {planCharge}</bold>，并将于 {renewalDate}续订。} other {该工作区的企业版计划设定为<bold>每年 {planCharge}</bold>，并将于 {renewalDate}续订。}}",
    "subscriptionSettings.subscriptionNextChargeMessage.legacyPlan": "{planInterval, select, month {此工作区的旧版计划已设定为<bold>每月 {planCharge}</bold>，并将于 {renewalDate}续订。} other {此工作区的旧版计划设定为<bold>每年 {planCharge}</bold>，并将于 {renewalDate}续订。}}",
    "subscriptionSettings.subscriptionNextChargeMessage.personalEducationPlan": "{planInterval, select, month {该工作区的个人专业版（教育）计划已设定为<bold>每月 {planCharge}</bold>，并将于 {renewalDate}续订。} other {该工作区的个人专业版（教育）计划已设定为<bold>每年 {planCharge}</bold>，并将于 {renewalDate}续订。}}",
    "subscriptionSettings.subscriptionNextChargeMessage.personalPlan": "{planInterval, select, month {该工作区的个人专业版计划已设定为<bold>每月 {planCharge}</bold>，并将于 {renewalDate}续订。} other {该工作区的个人专业版计划已设定为<bold>每年 {planCharge}</bold>，并将于 {renewalDate}续订。}}",
    "subscriptionSettings.subscriptionNextChargeMessage.teamPlan": "{planInterval, select, month {该工作区的团队版计划已设定为<bold>每月 {planCharge}</bold>，并将于 {renewalDate}续订。} other {该工作区的团队版计划已设定为<bold>每年  {planCharge}</bold>，并将于 {renewalDate}续订。}}",
    "subscriptionSettings.subscriptionStatus.cancellationMessage.enterprisePlan": "该工作区的<bold>企业版</bold>计划已于 {cancellationDate}取消，并将于 {expirationDate}到期。",
    "subscriptionSettings.subscriptionStatus.cancellationMessage.legacyPla": "该工作区的<bold>旧版</bold>计划已于 {cancellationDate}取消，并将于 {expirationDate}到期。",
    "subscriptionSettings.subscriptionStatus.cancellationMessage.personalEducationPlan": "该工作区的<bold>个人专业教育版</bold>计划已于{cancellationDate}取消，并将于 {expirationDate}到期。",
    "subscriptionSettings.subscriptionStatus.cancellationMessage.personalPlan": "该工作区的<bold>个人专业版</bold>计划已于 {cancellationDate}取消，并将于 {expirationDate}到期。",
    "subscriptionSettings.subscriptionStatus.cancellationMessage.teamPlan": "该工作区的<bold>团队版</bold>计划已于 {cancellationDate}取消，并将于 {expirationDate}到期。",
    "subscriptionSettings.subscriptionStatus.legacySubscriptionMessage": "我们的订阅系统目前正在移转中。请稍后再查看以了解新功能！",
    "subscriptionSettings.subscriptionStatus.nextPlan.personal": "当前计划到期后，该工作区将降级为个人版。",
    "subscriptionSettings.subscriptionStatus.nextPlan.team": "当前计划过期后，该工作区将降级为免费试用的团队版，块存储限制为 1,000 个。",
    "subscriptionSettings.subscriptionStatus.personalFreeUpgradeMessage": "该工作区为<bold>个人版</bold>。升级以使用 Notion 与更多人进行协作。",
    "subscriptionSettings.subscriptionStatus.proratedChargeMessage": "你将于 {upcomingChargeDate}按比例支付 {formattedInvoiceNextCharge}。",
    "subscriptionSettings.subscriptionStatus.reachedFreeBlockLimit": "该工作区使用了 {freeBlockLimit} 个块存储限制中的 {usedBlocks} 个块（占总存储的 {utilizationPercentage}）。",
    "subscriptionSettings.subscriptionStatus.remainingChargeMessage": "根据你的帐户余额进行调整后，你将需要支付 {formattedInvoiceNextCharge} 费用。",
    "subscriptionSettings.subscriptionStatus.teamTrialMessage": "该工作区是<bold>团队版</bold>的免费试用版，有块存储限制。",
    "subscriptionSettings.subscriptionStatus.upcomingInvoiceLink": "<upcominginvoicelink>查看下个发票</upcominginvoicelink>",
    ...
    "subscriptionSettings.upgradeToEnterpriseDialog.message": "系统会根据你当前的结算间隔和帐户余额按比例向你收取费用。",
    "subscriptionSettings.upgradeToEnterpriseDialog.withPossibleIntervalChange.message": "我们会根据你当前的结算时间间隔和帐户余额按比例向你收取费用。{notYearly, select, true {今后，你将每年支付账单。} false {}}",
    "subscriptionSettings.verifyingEligibilityMessage": "正在验证资格⋯",
    "subscriptionUpgradeDetails.features": "<span>{planName}的所有功能，</span>以及：",
    "subscriptionUpgradeDetails.learnMore": "了解更多",
    "subscriptionUpgradeDetails.oneLiner.enterprise": "运转公司所需的控制和支持。",
    "subscriptionUpgradeDetails.oneLiner.personal": "给想要更多的高级玩家。",
    "subscriptionUpgradeDetails.oneLiner.team": "让团队在一个地方写作、计划与合作。",
    ...
    "templatePicker.webEmptyPage.withTemplates.prompt": "{isTemplate, select, true{按 Enter 创建空白页，或选择模板}other{按 Enter 创建空白页，或选择模板（↑↓来选择）}}",
    ...
    "temporaryPasscodeLoginEmail.magicLink.text": "{hasExistingUser, select, true {点击此处使用该魔法链接登录} other {点击此处使用该魔法链接注册}}",
    "temporaryPasscodeLoginEmail.noNotionAccount.text": "我们找不到该邮箱地址上的帐户。",
    ...
    "temporaryPasscodeLoginEmail.setPermanentPassword.text": "提示：你可以在“设置与成员”→“我的帐户”中设定永久密码。",
    ...
    "toggleBlock.emptyBlock.placeholderText": "空的折叠列表。点击或拖动块到这里。",
    ...
    "topbar.presenceIndicator.hiddenUsers.otherCount.message": "{hiddenUsersCount, plural, other {及其他 {hiddenUsersCount} 位}}",
    ...
    "topbar.updatesButton.slackIntegrationButton.tooltip": "绑定 Slack 频道以获取有关该页面及其中页面的更新。",
    ...
    "transactionErrors.guestsoverLimit.message": "该工作区已达到最多访客数（5位）。",
    "transactionErrors.movingPagesToOtherWorkspacesNotAllowed.message": "此工作区已禁用将页面移动到其他工作区。",
    "transactionErrors.nonApiMovesNotAllowed.message": "请刷新（Cmd / Ctrl + R）以更新 Notion 后便可将页面移至其他工作区。",
    "transactionErrors.publicAccessNotAllowed.message": "该工作区不允许具有公开访问权限的页面。",
    ...
    "transactionErrors.workspaceTopLevelOperationNotAllowed.message": "该工作区已锁定修改侧边栏的工作区部分。",
    "transactionHelpers.requestTooLargeError.message": "抱歉，该请求太大。尝试导入？",
    ...
    "trashActions.deletePagePermanentlyDialog.confirmDeleteButton.label": "是的，删除该页面",
    "trashActions.deletePagePermanentlyDialog.prompt": "确定要永久删除该页面吗？",
    ...
    "updatesModal.arvhiveTab.emptyPrompt": "你归档的所有收件箱更新都将显示在这里。",
    "updatesModal.arvhiveTab.emptyPromptTitle": "没有已归档的更新",
    "updatesModal.currentPageTab.emptyPrompt": "对该页面的任何更改都将显示在这里。",
    "updatesModal.currentPageTab.emptyPromptTitle": "没有页面更新",
    "updatesModal.followedUpdatesTab.allArchived": "在任何页面的“更新”菜单中打开“关注该页面”，即可在这里接收更新。",
    ...
    "updatesModal.spaceUpdatesTab.allArchived": "当有人@提及你、回复你的评论或邀请你进入页面时，你将在这里收到通知。",
    "updatesModal.spaceUpdatesTab.allArchivedRequests": "当有人@提及你、回复你的评论、向你发送请求或邀请你进入页面时，你将在这里收到通知。",
    ...
    "uploadLimitExceededBanner.message": "{shouldShowShortMessage, select, true {文件超出 {maxFreeAccountFileSize}MB 大小限制} other {你的文件超过了免费计划的 {maxFreeAccountFileSize}MB 大小限制}}",
    ...
    "upsellActions.confirmProration.message": "系统会根据你当前的结算间隔和帐户余额按比例向你收取费用。",
    "upsellActions.confirmProrationAndYearlyInterval.message": "我们会根据你当前的结算时间间隔和帐户余额按比例向你收取费用。今后，你将每年支付账单。",
    ...
    "useCaseOnboarding.mobileDesktopStep.desktopApp.label": "Mac 和 Windows 应用",
    "useCaseOnboarding.mobileDesktopStep.title": "Notion 也可用于 <boldtext>Mac</boldtext>、<boldtext>Windows</boldtext> 和<boldtext>浏览器</boldtext>！所有内容将在你的多个设备上保持同步。",
    "useCaseOnboarding.mobileEditorSidebarStep.description": "你将在这里找到工作区页面和你的私人页面。",
    "useCaseOnboarding.mobileEditorSidebarStep.title": "<boldtext>侧边栏</boldtext>让一切井然有序。",
    "useCaseOnboarding.mobileEditorStep.description": "<boldtext>触摸并按住</boldtext>可以对任何内容重新排序。",
    "useCaseOnboarding.mobileEditorStep.title": "一些基本提示：",
    "useCaseOnboarding.mobileWebClipperStep.title": "<boldtext>将网页或本地文件保存到 Notion 中。</boldtext>",
    "useCaseOnboarding.webClipperStep.description": "只需点击分享按钮，然后选取要保存至的页面或数据库。",
    "useCaseOnboardingStep.cancelButton.label": "取消",
    "userCreditSettings.creditBalanceSection.applyCreditButton.label": "使用积分",
    "userCreditSettings.creditBalanceSection.creditBalanceMessage": "你目前的积分余额为 {creditBalance}。",
    "userCreditSettings.creditBalanceSection.freeMonthMessage": "{numberOfMonths, plural, other {这相当于<b> {numberOfMonths} 个月</b>的个人专业版计划。}}",
    "userCreditSettings.creditBalanceSection.maximumCreditBalanceExceeded": "你已经超出了每个帐户的最高积分余额 {maximumCreditBalance}。你赚取的任何其他积分都不会增加你的余额。",
    ...
    "userCreditSettings.inviteFriendsSection.showLessReferredUsers.link": "显示较少{numberOfReferredUsers}",
    "userCreditSettings.inviteFriendsSection.showMoreReferredUsers.link": "显示其他 {numberOfReferredUsers} 位",
    "userCreditSettings.inviteFriendsSection.sourceOfReferralNote": "（邀请你）",
    ...
    "userCreditSettings.otherWaysToEarnCreditSection.desktopApp.description": "下载桌面应用并登录",
    "userCreditSettings.otherWaysToEarnCreditSection.desktopApp.title": "在桌面应用中登录",
    "userCreditSettings.otherWaysToEarnCreditSection.evernoteImport.actionLink": "绑定",
    "userCreditSettings.otherWaysToEarnCreditSection.evernoteImport.description": "导入你的笔记和笔记本",
    "userCreditSettings.otherWaysToEarnCreditSection.evernoteImport.title": "从 Evernote 导入",
    "userCreditSettings.otherWaysToEarnCreditSection.mobileApp.actionLink": "下载",
    "userCreditSettings.otherWaysToEarnCreditSection.mobileApp.description": "下载移动应用并登录",
    "userCreditSettings.otherWaysToEarnCreditSection.mobileApp.title": "在移动应用中登录",
    "userCreditSettings.otherWaysToEarnCreditSection.mobileShare.actionLink": "下载",
    "userCreditSettings.otherWaysToEarnCreditSection.mobileShare.description": "使用分享菜单将链接保存到 Notion 中",
    "userCreditSettings.otherWaysToEarnCreditSection.mobileShare.title": "使用 iOS 或安卓系统分享菜单",
    "userCreditSettings.otherWaysToEarnCreditSection.totalCreditSummaryText": "赚取的总积分 ",
    "userCreditSettings.otherWaysToEarnCreditSection.webApp.actionLink": "访问",
    "userCreditSettings.otherWaysToEarnCreditSection.webApp.description": "从任何网页浏览器登录到 Notion",
    "userCreditSettings.otherWaysToEarnCreditSection.webApp.title": "在网页版登录",
    "userCreditSettings.otherWaysToEarnCreditSection.webClipper.actionLink": "安装",
    "userCreditSettings.otherWaysToEarnCreditSection.webClipper.description": "下载 Chrome 扩展程序并保存链接",
    "userCreditSettings.otherWaysToEarnCreditSection.webClipper.title": "使用网页剪裁器",
    "userCreditSettings.otherWaysToEarnCreditSectionAlt.title": "赚取积分的方法",
    ...
    "userDataConsentSettings.accessNotGranted.label": "授予 Notion 支持人员对你的帐户的临时访问权限，以便我们代表你解决问题或恢复内容。你可以随时撤销访问权限。",
    ...
    "userPermissionsMenu.removePermissionsModal.removeSelfFromPage.confirmationMessage": "确定要删除自己的访问权限？",
    "userPermissionsMenu.removePermissionsModal.removeSelfFromWorkspace.confirmationMessage": "确定要删除自己的访问权限？你将无法访问工作区，并且所有私人页面都将丢失。",
