...
(function () {
  ...
  script.text = JSON.stringify({
    ...
    "BlockPropertyValueOverlay.bulkAiAutofillButton.largeBulkFillUpsellMessage":
      "取得 AI 附加元件以立即更新多於 {maxItems} 的頁面",
    ...
    "ContextualInviteEmail.clickToJoinTeam.message": "在 Notion 上加入你的團隊",
    ...
    "ContextualInviteV2Email.pageInviteMessage": "{name} 與你分享了 {pageName}",
    ...
    "GetNotifiedDropdown.onlyCommentsAllComments.label": "所有評論",
    ...
    "GetNotifiedDropdown.simpleAllUpdates.caption": "更改所有评论和属性",
    ...
    "SlackNotificationAction.caption.reconnectNeeded": "重新連線 Slack 以恢復",
    ...
    "SprintsBoardOnboardingTooltip.SprintBoardView.header": "管理目前的 Sprint",
    ...
    "activity.blockEdited.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已更新 {pageTitle}}}",
    ...
    "activity.commentActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已評論}}",
    "activity.commentDocActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 有在文件上留言}}",
    "activity.commentMeetingActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 有在會議記錄上留言}}",
    "activity.commentProjectActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 有在專案上留言}}",
    "activity.commentTaskActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 有在任務上留言}}",
    "activity.commentWikiActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 有在知識庫上留言}}",
    ...
    "activity.mentionActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已在頁面中提及你}}",
    "activity.mentionProjectActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已在專案中提及你}}",
    "activity.mentionTaskActivity.header":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 指派你至 {pageName}}}",
    "activity.mentionTaskActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已向你指派任務}}",
    ...
    "activity.titleCard.members.otherCount.message":
      "{remainingAvatarCount, plural, other {+{remainingAvatarCount}}}",
    ...
    "activity.userInvitedActivityDoc.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已邀請你加入文件}}",
    ...
    "activity.userInvitedActivityGroupId.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已邀請你加入 {groupName} 群組}}",
    ...
    "activity.userInvitedActivityMeeting.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已邀請你加入會議}}",
    ...
    "activity.userInvitedActivityNavigableBlock.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已邀請你加入頁面}}",
    ...
    "activity.userInvitedActivityOtherInvite.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已邀請你加入工作區}}",
    ...
    "activity.userInvitedToTeamActivity.standardizedHeader":
      "{numberOfAuthors, plural, other {{authorOrAuthors} 已邀請你加入團隊空間}}",
    ...
    "ai.favoriteActions.linkCopied": "連結已複製。請分享給可能會用到的其他人。",
    ...
    "ai.gtmFavoriteActions.add": "新增至 AI 最愛",
    ...
    "aiAutofill.feedbackPopup.feedbackInputPlaceholder":
      "如何改善輸出？（選用）",
    "aiAutofill.feedbackPopup.shareWithNotion": "與 Notion 分享 AI 說明和輸出",
    ...
    "appTemplateUpgradeActions.upgradeConfirmationDialog.cancelUpgrade.label":
      "不要升級",
    "appTemplateUpgradeActions.upgradeConfirmationDialog.upgrade.label": "升級",
    ...
    "asanaImportOption.asanaButton.accountDelinkingInProgress": "移除帳戶中...",
    ...
    "assistant.acceptAllButton": "全都接受",
    ...
    "automationEventTriggerMenu.pagePropertiesEditedSection.title":
      "已編輯頁面屬性",
    "automationEventTriggerMenu.searchInputPlaceholder.label": "搜尋觸發程序…",
    ...
    "automations.editAutomationView.updatedConfirmation":
      "已更新 {automationName}",
    "automations.editSlackView.createdConfirmation": "{automationName} 已建立",
    "automations.editSlackView.updatedConfirmation": "已更新 {automationName}",
    "automations.eventActionProperty.menuHeaderTitle": "將 {propertyName} 設為",
    ...
    "collectionSettings.automationsView.showMore": "{number}查看更多",
    "collectionSettings.createSlackAutomationView.title": "新 Slack 通知",
    "collectionSettings.createStatusAutomationView.menuTitle": "建立狀態自動化",
    ...
    "collectionSettings.slackAutomationsView.showMore": "{number}查看更多",
    ...
    "collectionSettings.subitemsView.tasks.turnOnSubitemsButton.label":
      "開啟子任務",
    "collectionSettings.subitemsView.turnOnSubitemsButton.label": "開啟子項目",
    ...
    "completeAutomationSprintModal.sprintSummary.incompleteTasksLabel":
      "{incompleteTaskCount, plural, other {找到 {incompleteTaskCount} 個未完成任務}}",
    ...
    "completions.CompletionMenuActionBar.tryAgain.clickToEditAndRetry":
      "按一下以編輯提示並重試",
    "completions.CompletionMenuActionBar.tryAgain.clickToRetry": "按一下以重試",
    ...
    "consolidationCompletedEmail.closingText": "謝謝你。{br}Notion 團隊　敬上",
    ...
    "database.propertyTypeName.text.extractInfoWithAI": "透過 AI 擷取關鍵資訊",
    ...
    "database.relationMenuRow.tooltip.addPage.messageSprints": "新增此 Sprint",
    ...
    "database.relationProperty.relatedPages.limit.subHeaderMultipleSprints":
      "{count, plural, other {{count} 個選取的 Sprint}}",
    ...
    "database.relationProperty.unrelatedPages.subHeaderSprints": "移至 Sprint",
    ...
    "database.viewSettings.githubConfigTab.connect": "連接到 GitHub（工作區）",
    ...
    "database.viewSettings.newPropertyOnTypedDatabase": "加入到 {databaseName}",
    ...
    "database.viewSettings.propertyTab.aiAutofill.actionsSectionLabel": "動作",
    ...
    "database.viewSettings.propertyTab.aiAutofill.removeAutofillButton":
      "關閉透過 AI 填寫",
    "database.viewSettings.propertyTab.aiAutofill.saveButtonAllSaved": "已儲存",
    ...
    "database.viewSettings.propertyTab.aiAutofill.tryOnPage": "在此頁面上試用",
    ...
    "database.viewSettings.typedDbPropertyTypeSelect.searchPlaceholder": "搜尋",
    "database.viewSettings.viewActionMenu.cannotRename": "此視圖不能重新命名。",
    ...
    "desktopEmailConfirmPage.description2": "確認後即可返回桌面 APP 完成註冊。",
    ...
    "general.mfa.error.unsupportedPhoneNumber":
      " {countryName}目前不提供 SMS 驗證。可考慮使用驗證器應用程式作為替代的驗證方式。",
    ...
    "identityProvisioningSettings.managedUsers.details.emailLabel": "電子郵件",
    ...
    "identityProvisioningSettings.managedUsers.details.saveButton": "儲存變更",
    ...
    "identityProvisioningSettings.managedUsers.removeFromWorkspace.confirmation.descriptionWithDeletion":
      "此用戶將無法再進入您刪除他們的工作區。 <b>該工作區將被刪除</b>因為此用戶是唯一的成員。此操作為不可逆。",
    ...
    "login.mfa.backupCode.goToAccountSettingsButton": "前往帳戶設定",
    "login.mfa.backupCode.regenerateBackupCodes.codeRemaining.header":
      "您海剩下 {numRemainingCodes} 備用代碼。",
    "login.mfa.backupCode.regenerateBackupCodes.noCodeRemaining.header":
      "您的恢復代碼已全部用完。請在瀏覽器或桌面應用程式中，前往<boldtext>設定和成員</boldtext> > <boldtext>我的帳戶</boldtext> > <boldtext>雙重驗證</boldtext>以建立新代碼。",
    "login.mfa.backupCode.regenerateBackupCodesTitle": "重新生成備用代碼",
    ...
    "midtermChangeHelpers.snackbar.billingInterval.future":
      "{billingInterval, select, year {年繳} other {月繳}} 帳單將於 {date} 生效",
    "midtermChangeHelpers.snackbar.billingInterval.success":
      "你已成功變更為 {billingInterval, select, year {年繳} other {月繳}} 帳單",
    ...
    "midtermChangeHelpers.snackbar.downgradePlan.plus":
      "降級至加值方案將於 {date} 生效。",
    "midtermChangeHelpers.snackbar.purchaseAddOn.ai": "你已成功新增 Notion AI",
    "midtermChangeHelpers.snackbar.removeAddOn.ai":
      "{effectiveDate} 的 AI 移除將生效",
    "midtermChangeHelpers.snackbar.upgradePlan.business":
      "你已成功升級至商用方案",
    "midtermChangeHelpers.snackbar.upgradePlan.enterprise":
      "你已成功升級至企業方案",
    "midtermChangeHelpers.snackbar.upgradePlan.plus": "你已成功升級至加值方案",
    "midtermChangeHelpers.snackbar.upgradePlan.student":
      "你已成功升級至學生方案",
    "midtermSubscriptionHelpers.cancellationFailed":
      "一項錯誤試圖取消你的待處理變更。請再試一次。",
    "midtermSubscriptionHelpers.cancellationSucceeded": "待處理的變更已經取消",
    "midtermSubscriptionHelpers.invalidSubscriptionId":
      "無法取消你待處理的變更。你待處理的訂閱變更有些問題。",
    "midtermSubscriptionHelpers.unableToCancel":
      "我們現在無法取消你預定的變更。請聯絡支援人員獲得更多協助。",
    "miniPeek.success.copyLink": "拷貝連結",
    "miniPeek.success.label":
      "新增 <boldtext>{targetTitle}</boldtext> 至 <boldtext>{parentTitle}</boldtext>",
    "miniPeek.success.view": "視圖",
    ...
    "mixpanelBlock.embeds.caption": "適用於 Mixpanel 專案",
    "mixpanelBlock.placeholder": "嵌入 Mixpanel 專案",
    ...
    "moveBlockMenu.TeamSidebarLocked.tooltip":
      "此團隊空間已鎖定其側邊欄。你必須是團隊空間擁有者才能移動到此團隊空間。",
    ...
    "moveBlockMenu.needEditAccess.tooltip":
      "你需要「{parentName}」的「可以編輯」存取權限才能移動此頁面",
    ...
    "newBlock.drawing.description": "在無限的畫布上繪畫並插入圖表。",
    "newBlock.drawing.fuzzySearchKeywords":
      "繪圖 圖表 畫布 插圖 繪畫 素描 tldraw 塗鴉 心智圖 架構 漆油筆",
    "newBlock.drawing.title": "繪圖",
    ...
    "newBlock.mixpanel.description": "嵌入 Mixpanel 專案。",
    ...
    notionProjectTutorial_task2_0: "目標：",
    notionProjectTutorial_task2_0_0: "為效能專案排定專案啟動會議",
    notionProjectTutorial_task2_0_1: "提前準備會議資料",
    notionProjectTutorial_task2_0_2: "會議目標旨在審核專案提案",
    notionProjectTutorial_task2_1: "非目標：",
    notionProjectTutorial_task2_1_0: "對其他效能專案進行腦力激盪",
    notionProjectTutorial_task2_2: "下一個步驟：",
    notionProjectTutorial_task2_2_0: "邀請所有利害關係人參加會議",
    notionProjectTutorial_task2_2_1: "準備會議議程",
    ...
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_2_0:
      "Notion 內的 Sprint 均以 4 核心概念構建",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_3_0: "專案 —",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_3_1:
      "每個專案都會開啟成自有頁面（就跟這個一樣！）並可在頁面內新增任務和專案詳情。你所有的專案都將收集在你新建立的專案頁面內。",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_4_0: "任務",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_4_1: "空",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_5_0: "Sprint —",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_5_1:
      "Sprint 是時間的度量，可包含任何數量的任務。可以在你的 Sprint 頁面或任何任務頁面，查看任務並將其分派至多個 Sprint。",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_6_0:
      "Sprint 看板 —",
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_6_0_0:
      "此外，使用 Sprint 看板自動完成 Sprint",
    ...
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_6_1:
      "Sprint 看板結合了上述所列的所有概念，以便能查看你的任務（以專案分組），並依據你目前的 Sprint 進行篩選。",
    ...
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_8_0:
      "可自訂你的專案與任務設置來匹配你團隊的工作風格。如需了解更多，請前往",
    ...
    notionProjectsTutorialProjectsGettingStartedWithAgileV2_AiSummary:
      "此頁面概述了如何使用 Notion 的四核心概念進行 Sprint 規劃：專案、任務、Sprint 和 Sprint 看板。而且還提供了完成 Sprint 的簡要指南，以及連結至 Notion 說明中心以獲取更多的詳細資料。",
    notionProjectsTutorialProjectsGettingStartedWithProjectsAiSummary:
      "本文件提供了使用專案管理追蹤程式整理任務、專案及 Sprint 的說明。其解釋了如何使用提供的模板、加入自訂欄位，以及自訂視圖。任務是最小的工作單位，專案代表大型工作，而 Sprint 是完成任務的個別時間週期。模板包括任務狀態和受託人等常見欄位，但使用者可以加入自己的欄位，像是優先級和任務類型。",
    ...
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_1_0:
      "專案和任務是用 4 核心概念構建",
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_3_0: "專案 —",
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_3_1:
      "每個專案都有自己的頁面",
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_4_0: "任務",
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_4_1: "空",
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_5_0: "屬性 —",
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_5_1: "將",
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_6_0: "視圖 —",
    ...
    notionProjectsTutorialProjectsGettingStartedWithProjectsV2_AiSummary:
      "本文件介紹了 Notion 的專案與任務，包括四核心概念：專案、任務、屬性和視圖。每一項都自有頁面，可用屬性進行標記。視圖能做自訂版面和篩選器。如需更多的自訂選項，請瀏覽 Notion 說明中心。",
    ...
    notionProjectsTutorial_getStartedTasksPage1AiSummary:
      "本文件提供將新任務加入到任務追蹤系統的說明。每項任務都可以自訂任務 ID、受託人、狀態、到期日期、優先級和標籤。",
    notionProjectsTutorial_getStartedTasksPage1_0:
      "準備好開始在此追蹤你的任務了嗎？先點選表格右上方的藍色「新增」按鈕。",
    notionProjectsTutorial_getStartedTasksPage1_1:
      "透過填入上方欄位自訂每項任務，例如任務的受託人、到期日及狀態。",
    notionProjectsTutorial_getStartedTasksPage2: "邀請團隊成員",
    notionProjectsTutorial_getStartedTasksPage2AiSummary:
      "本文件提供邀請團隊成員對任務進行協作的說明。使用分享功能表以邀請團隊成員，並使用「受託人」欄位指派任務。團隊成員會在他們的側邊欄中收到通知。",
    notionProjectsTutorial_getStartedTasksPage2_0:
      "準備好與你的團隊協作了嗎？使用右上方的分享功能表。",
    notionProjectsTutorial_getStartedTasksPage2_1:
      "使用上方「受託人」將任務指派給你的團隊成員。他們會在自己的側邊欄中看到通知。",
    notionProjectsTutorial_inProgress: "進行中",
    notionProjectsTutorial_notStarted: "未開始",
    notionProjectsTutorial_planning: "規劃",
    notionProjectsTutorial_project1: "專案 1",
    notionProjectsTutorial_project1AiSummary:
      "行動裝置團隊優先考慮效能並投資更多的 iOS 和 Android 原生元件。團隊在去年成功將頁面載入時間縮短 50%，進而增加了行動裝置使用率和正面的 APP 商店評價。專案目前處於規劃階段，並預計開發效能儀表板和專案任務。",
    notionProjectsTutorial_project1_heading0: "關於此專案",
    notionProjectsTutorial_project1_heading1: "效能儀表板",
    notionProjectsTutorial_project1_heading2: "專案任務",
    notionProjectsTutorial_project1_paragraph0:
      "團隊在去年優先考慮行動裝置效能，並成功將頁面載入時間縮短 50%。這與漸增的行動裝置使用率以及更正面的 APP 商店評價有直接關聯。",
    notionProjectsTutorial_project1_paragraph1:
      "行動裝置團隊本季更專注於效能，並投資了更多的 iOS 和 Android 原生元件。",
    notionProjectsTutorial_project2: "專案 2",
    notionProjectsTutorial_project2AiSummary:
      "使用者教育團隊為其 APP 規劃了專案要重新設計引導流程，且目標為增加 25% 的 7 日留用率。對於許多使用者來說，目前引導流程的資訊量過於龐雜，而團隊希望建立更有效率的使用者旅程。該專案期程排定在 2023 年 5 月 8 日到 2023 年 6 月 4 日。",
    notionProjectsTutorial_project2_heading1: "建議的使用者旅程",
    notionProjectsTutorial_project2_paragraph0:
      "因為我們的 APP 有好多功能，角色和用例也很多，所以許多使用者都認為目前引導流程的資訊量過於龐雜，所以發出讚嘆聲的速度來得不夠快。",
    notionProjectsTutorial_project2_paragraph1:
      "使用者教育團隊在本季投資了整體重新設計的引導流程，且目標為增加 25% 的 7 日留用率。",
    ...
    notionProjectsTutorial_task1AiSummary:
      "本專案提案旨在達成第三季行動裝置效能投資的跨職能部門共識。目標包括加入使用者故事和特定問題陳述，而非目標包括取得領導層級簽核及合成使用者調研學習。下一個步驟包括收集行動裝置團隊的回饋，以及在適當的 Slack 頻道中與內部通訊建立意識。",
    notionProjectsTutorial_task1_0: "目標：",
    notionProjectsTutorial_task1_0_0:
      "在第三季就我們投資行動裝置效能的原因和方式達成跨職能部門共識",
    notionProjectsTutorial_task1_0_1:
      "包括使用者故事、特定問題陳述，並且清楚說明暫時不在範圍內的項目",
    notionProjectsTutorial_task1_1: "非目標：",
    notionProjectsTutorial_task1_1_0: "取得明確的領導層級簽核",
    notionProjectsTutorial_task1_1_1:
      "合成使用者調研學習（已於研究團隊的效能文件擷取）",
    notionProjectsTutorial_task1_2: "下一個步驟：",
    notionProjectsTutorial_task1_2_0: "收集行動裝置團隊的回饋",
    notionProjectsTutorial_task1_2_1:
      "在適當的 Slack 頻道中使用內部通訊建立意識",
    notionProjectsTutorial_task1_epd: "行動應用程式效能",
    notionProjectsTutorial_task2: "任務 2",
    notionProjectsTutorial_task2AiSummary:
      "此任務進行中並涉及排定效能專案的專案啟動會議、提前準備會議資料，以及邀請所有利害關係人加入會議。非目標包括對其他效能專案進行腦力激盪。到期日期為 2023 年 4 月 26 日，優先級為中。該任務被標記為「行動裝置」。",
    notionProjectsTutorial_task2_epd: "啟用表情符號反應",
    notionProjectsTutorial_task3: "任務 3",
    notionProjectsTutorial_task3AiSummary:
      "本文件概述了研究任務的目標和非目標，其中包括瞭解需要最多教育的產品區域，以及取消高度參與區域的優先順序。下一個步驟為觀看全 10 場訪談並在 Slack 中分享深入解析。",
    notionProjectsTutorial_task3_0: "目標：",
    notionProjectsTutorial_task3_0_0: "了解需要最多教育的產品區域",
    notionProjectsTutorial_task3_0_1: "取消已出現高度參與之產品區域的優先順序",
    notionProjectsTutorial_task3_1: "非目標：",
    notionProjectsTutorial_task3_1_0: "建議變更核心產品的使用者介面",
    notionProjectsTutorial_task3_1_1: "建議變更產品藍圖",
    notionProjectsTutorial_task3_2: "下一個步驟：",
    notionProjectsTutorial_task3_2_0: "觀看研究團隊全 10 場的訪談",
    notionProjectsTutorial_task3_2_1: "撰寫深入解析並在 Slack 中分享",
    notionProjectsTutorial_task3_epd: "更好的錯誤處理方式",
    notionProjectsTutorial_task4: "任務 4",
    notionProjectsTutorial_task4AiSummary:
      "此任務旨在建立資料儀表板，以將啟用和留用與控制群組互相衡量，並讓跨職能部門合作夥伴能夠在新使用者同類群組之間，自行取得工具提示有效性的資訊。下一個步驟包括向 Jonny 要求 Hex 的存取權限，並排定跨職能部門會議以取得回饋和要求。此非目標旨在追蹤工具提示被略過的頻率。",
    notionProjectsTutorial_task4_0: "目標：",
    notionProjectsTutorial_task4_0_0:
      "讓跨職能部門合作夥伴能夠在新使用者同類群組之間，自行取得工具提示有效性的資訊",
    notionProjectsTutorial_task4_0_1: "將啟用和留用與控制群組互相衡量",
    notionProjectsTutorial_task4_1: "非目標：",
    notionProjectsTutorial_task4_1_0: "加入新事件以追蹤新功能採用情形",
    notionProjectsTutorial_task4_1_1: "追蹤工具提示被略過的頻率（暫時封鎖）",
    notionProjectsTutorial_task4_2: "下一個步驟：",
    notionProjectsTutorial_task4_2_0: "向 Jonny 要求 Hex 的存取權限",
    notionProjectsTutorial_task4_2_1:
      "排定跨職能部門會議以收集任何剩餘的回饋和要求",
    notionProjectsTutorial_task4_epd: "撰寫單元測試",
    notionProjectsTutorial_task5: "範圍工作提示專案",
    notionProjectsTutorial_task5AiSummary:
      "本文件概述了工具提示專案的範圍，包括找出技術封鎖程式和估計工程時間，以及評估新事件和收集回饋的非目標。下一個步驟包括重新瀏覽上一個專案的文件，並且撰寫技術規格以分享給產品團隊電子郵件別名。",
    notionProjectsTutorial_task5_0: "目標：",
    notionProjectsTutorial_task5_0_0: "找出建立教育工具提示的任何技術封鎖程式",
    notionProjectsTutorial_task5_0_1: "估計工程需要多久時間才能建立工具提示",
    notionProjectsTutorial_task5_1: "非目標：",
    notionProjectsTutorial_task5_1_0: "評估新事件供資料團隊進行追蹤",
    notionProjectsTutorial_task5_1_1: "收集跨職能部門合作夥伴的回饋",
    notionProjectsTutorial_task5_2: "下一個步驟：",
    notionProjectsTutorial_task5_2_0: "重新瀏覽第一季先前工具提示專案的文件",
    notionProjectsTutorial_task5_2_1:
      "撰寫技術規格並分享給產品團隊電子郵件別名",
    notionSprintsNewSprintTemplate_0_0: "規劃筆記",
    notionSprintsNewSprintTemplate_1_0_0: "團隊可用性",
    notionSprintsNewSprintTemplate_1_0_0_0: "PTO",
    notionSprintsNewSprintTemplate_1_1_0: "上次的 Sprint 審核",
    notionSprintsNewSprintTemplate_1_1_0_0: "哪些工作進展順利",
    notionSprintsNewSprintTemplate_1_1_1_0: "哪些工作可能變得不同",
    notionSprintsNewSprintTemplate_1_2_0: "Sprint 規劃",
    notionSprintsNewSprintTemplate_1_2_0_0: "目前的 Sprint 目標",
    notionSprintsNewSprintTemplate_1_2_1_0: "將任務投入到 Sprint",
    notionTasksNewBugTemplate_0: "錯誤",
    notionTasksNewBugTemplate_0_0: "說明",
    notionTasksNewBugTemplate_10_0: "其他資訊",
    notionTasksNewBugTemplate_11_0: "來源 URL：🔗",
    notionTasksNewBugTemplate_12_0: "主控台日誌檔：🔗",
    notionTasksNewBugTemplate_1_0: "發生狀況的說明",
    notionTasksNewBugTemplate_2_0: "預期行為：",
    notionTasksNewBugTemplate_3_0: "實際行為：",
    notionTasksNewBugTemplate_4_0: "螢幕截圖/GIF/影片",
    notionTasksNewBugTemplate_7_0: "重現步驟",
    notionTasksNewFeatureRequestTemplate_0: "功能要求",
    notionTasksNewFeatureRequestTemplate_0_0: "說明",
    notionTasksNewFeatureRequestTemplate_10_0: "其他筆記",
    notionTasksNewFeatureRequestTemplate_11_0: "[加入可能有幫助的其他項目]",
    notionTasksNewFeatureRequestTemplate_1_0: "[功能要求的說明]",
    notionTasksNewFeatureRequestTemplate_3_0: "使用者問題",
    notionTasksNewFeatureRequestTemplate_4_0: "[說明此功能會解決的問題]",
    notionTasksNewFeatureRequestTemplate_6_0: "螢幕截圖/GIF/影片",
    notionTasksNewSprintTemplate_0: "新的 Sprint",
    notionTasksNewSprintTemplate_0_0: "Sprint 規劃議程",
    notionTasksNewSprintTemplate_10_0: "Sprint 規劃",
    notionTasksNewSprintTemplate_11_0: "檢閱待辦需求",
    notionTasksNewSprintTemplate_12_0: "將任務投入到 Sprint",
    notionTasksNewSprintTemplate_13_0: "進行中",
    notionTasksNewSprintTemplate_14_0: "未開始",
    notionTasksNewSprintTemplate_15_0: "完成",
    notionTasksNewSprintTemplate_16_0: "已歸檔",
    notionTasksNewSprintTemplate_17_0: "依照狀態",
    notionTasksNewSprintTemplate_18_0: "任務",
    notionTasksNewSprintTemplate_19_0: "由受託人",
    notionTasksNewSprintTemplate_1_0: "團隊可用性",
    notionTasksNewSprintTemplate_2_0: "PTO",
    notionTasksNewSprintTemplate_3_0: "其他承諾",
    notionTasksNewSprintTemplate_4_0: "上次的 Sprint 審核",
    notionTasksNewSprintTemplate_5_0: "哪些工作進展順利",
    notionTasksNewSprintTemplate_6_0: "哪些工作可能變得不同",
    notionTasksNewSprintTemplate_7_0: "展示",
    notionTasksNewSprintTemplate_8_0: "Sprint 目標",
    notionTasksNewSprintTemplate_9_0: "[在此加入此 Sprint 的目標]",
    notionTasksNewTaskTemplate_0: "任務",
    notionTasksNewTaskTemplate_0_0: "說明",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.readContentWithAdminAccess.description":
      "{integrationName} 將能查看你工作區內的所有頁面",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.viewUsers.detail":
      "「{integrationName}」將可查看所有工作區成員和訪客的基本資訊，例如姓名和個人檔案圖片，但無法查看其電子郵件位址",
    ...
    "oauthAuthorizationPage.permissionStep.permissionListItem.viewUsersAndEmail.detail":
      "「{integrationName}」將可查看所有工作區成員的基本資訊和訪客資料，包括姓名、個人檔案圖片和電子郵件位址",
    ...
    "onboardingSurvey.companySize.v2.label": "你的公司大約有多少員工？",
    ...
    "onboardingSurvey.useCase.v2.label": "你打算將 Notion 用於什麼內容？",
    ...
    "openInDesktopAppSettings.closeBrowserTabs.caption":
      "在桌面程式開啟連結時，請關閉「正在重新導向至你的 Notion 程式...」瀏覽器分頁。",
    ...
    "pageDescription.sprintBoard.message": "了解如何使用 Sprint",
    ...
    "pageViewBlock.add.tooltips.pageIcon": "點選此處可用圖示自訂你的頁面。",
    ...
    "pageViewBlock.miniPeekView.emptyTitlePlaceholder": "開始寫入...",
    ...
    "pageViewBlock.trashBanner.restoreNotionProjects.label": "恢復 Notion 專案",
    ...
    "passwordSetting.changePasswordButton.label": "變更密碼",
    ...
    "passwordSettings.passwordMissingNumber.message":
      "請在密碼中包含數字，或使用更長的密碼。",
    "passwordSettings.passwordModal.changePasswordButton.label": "變更密碼",
    ...
    "passwordSettings.passwordModal.newPasswordInput.label": "輸入新密碼",
    "passwordSettings.passwordModal.newPasswordInput.placeholder": "新密碼",
    "passwordSettings.passwordModal.passwordGuidelines":
      "密碼長度至少為 15 個字母，或者長度至少為 8 個字元且同時包含字母和數字。",
    "passwordSettings.passwordModal.removePasswordButton.label": "移除密碼",
    "passwordSettings.passwordModal.setPasswordButton.label": "設定密碼",
    ...
    "passwordSettings.passwordUpdatedModal.passwordUpdatedModal.title":
      "你的密碼已儲存",
    "passwordSettings.removePasswordModal.continueButton.label": "繼續",
    ...
    "passwordSettings.removePasswordModal.educationPlanWarning.message":
      "如果你遺失學校電子郵件的存取權限，即無法重新登入 Notion。",
    "passwordSettings.removePasswordModal.header":
      "當你嘗試登入時，你會透過電子郵件收到連結和登入碼。",
    ...
    "passwordSettings.removePasswordModal.removeMfaWarning.message":
      "<boldtext>如果你繼續操作，也會移除雙步驟驗證。</boldtext>",
    "passwordSettings.removePasswordModal.title": "移除臨時登入碼的密碼？",
    "passwordSettings.removePasswordSuccessModal.header":
      "若要登入你的帳戶，我們會將臨時登入碼傳送到你的電子郵件。",
    "passwordSettings.removePasswordSuccessModal.title": "已移除密碼",
    "passwordSettings.setPassword.message": "設定永久密碼以登入你的帳號。",
    ...
    "peekModeIntroTooltip.subtitle.aiFyiTooltip":
      "透過 AI 產生的摘要查看最新更新",
    "peekModeIntroTooltip.subtitle.assignToSomeone": "按一下以選擇一或多位人員",
    "peekModeIntroTooltip.subtitle.changeTaskStatus":
      "按一下以將狀態變更至「進行中」或其他狀態",
    "peekModeIntroTooltip.subtitle.clickViewSettings":
      "進一步設定你的任務版面配置、分組、屬性等項",
    "peekModeIntroTooltip.subtitle.createATask":
      "從頭開始或使用下拉式選單以選擇模板",
    "peekModeIntroTooltip.title": "新功能！以側邊預覽開啟頁面",
    "peekModeIntroTooltip.title.aiFyiTooltip": "透過 AI 自動填寫文字",
    "peekModeIntroTooltip.title.assignToSomeone": "將其指派給某人",
    "peekModeIntroTooltip.title.changeTaskStatus": "更新狀態",
    "peekModeIntroTooltip.title.clickViewSettings": "設定你的任務",
    "peekModeIntroTooltip.title.createATask": "建立新任務",
    "peekMoveToMenu.addTo.addTo": "加入到",
    "peekMoveToMenu.addTo.privatePages": "私人頁面",
    "peekMoveToMenu.prefix.in": "在",
    "peekMoveToMenu.tooltip": "設定預設頁面或資料庫",
    ...
    "peekTopbar.pageTypePicker.page": "頁面",
    "peekTopbar.pageTypePicker.prefix": "全新",
    ...
    "personalSlackNotificationsAccountDropdownButton.disableNotification.label":
      "關閉",
    planningNotesButtonTemplate_0_0: "Sprint # 規劃",
    planningNotesButtonTemplate_1_0: "團隊可用性",
    planningNotesButtonTemplate_1_1: "PTO",
    planningNotesButtonTemplate_2_0: "上次的 Sprint 審核",
    planningNotesButtonTemplate_2_1: "哪些工作進展順利",
    planningNotesButtonTemplate_2_2: "哪些工作可能變得不同",
    planningNotesButtonTemplate_3_0: "Sprint 規劃",
    planningNotesButtonTemplate_3_1: "目前的 Sprint 目標",
    planningNotesButtonTemplate_3_2: "將任務投入到 Sprint",
    "plus.title": "加值版",
    "plusEducationPlan.title": "教育加值版",
    "plusPlan.title": "加值版",
    "pmAnnouncementBanner.caption": "任務 & 專案資料庫將移至你的團隊空間。",
    "pmAnnouncementBanner.dismiss": "刪除此示範",
    "pmAnnouncementBanner.help":
      "任務和專案資料庫將移至你個團隊空間，但沙箱將會刪除。",
    "pmAnnouncementBanner.moveTo": "移至團隊空間",
    "pmAnnouncementBanner.moveToPrivate": "開始使用 Notion 專案",
    "pmAnnouncementBanner.moveToTeam": "新增至團隊空間",
    "pmAnnouncementBanner.title":
      "Notion 專案能輕鬆協作。將此示範移動至團隊空間，一起跟團隊成員管理專案。",
    "pmAnnouncementBanner.titlePrivate": "是否準備好開始使用 Notion 專案？",
    "pmAnnouncementModal.dismiss": "關閉",
    "pmAnnouncementModal.learnMore": "了解更多",
    "pmAnnouncementModal.subheader.firstLine": "從構思管理專案",
    "pmAnnouncementModal.subheader.mobile":
      "在 AI 驅動的工作區從構思到執行來管理專案。",
    "pmAnnouncementModal.subheader.secondLine":
      "以便在一個 AI 驅動的工作區執行。",
    "pmAnnouncementModal.title.firstLine": "認識新的",
    "pmAnnouncementModal.title.secondLine": "Notion 專案",
    "pmAnnouncementModal.tryIt": "立即試用",
    "pmAnnouncementSidebar.body":
      "在一個 AI 驅動的工作區將專案從構思進行到啟動。",
    "pmAnnouncementSidebar.cta": "立即試用",
    "pmAnnouncementSidebar.header": "Notion 專案",
    "pmIntroTooltip.subtitle.aiFyiTooltip": "以 AI 產生的摘要查看最新的更新",
    "pmIntroTooltip.subtitle.assignToSomeone": "點選可選取一位或多位人員",
    ...
    "pmIntroTooltip.subtitle.createATask":
      "從頭開始或使用下拉功能表選取或建立範本",
    "pmIntroTooltip.subtitle.selectAProject": "點選可將此任務加入專案",
    "pmIntroTooltip.title.aiFyiTooltip": "藉由 AI 自動填寫",
    "pmIntroTooltip.title.assignToSomeone": "將其指派給某人",
    "pmIntroTooltip.title.changeTaskStatus": "更新狀態",
    "pmIntroTooltip.title.clickViewSettings": "設定你的任務",
    "pmIntroTooltip.title.createATask": "建立新任務",
    "pmIntroTooltip.title.selectAProject": "選取專案",
    "pmLaunchSandbox.createdInPrivate": "Notion 專案已加入到你的私人分區",
    "pmLaunchSandbox.notionProjects": "Notion 專案",
    "pmLaunchSandbox.projects": "專案",
    "pmLaunchSandbox.snackBar.createdInPrivate":
      "Notion 專案已加入到你的私人分區",
    "pmLaunchSandbox.snackBar.movedToTeam": "已將任務和專案移動到 {team}。",
    "pmLaunchSandbox.sprints": "Sprint",
    "pmLaunchSandbox.tasks": "任務",
    "pmLaunchSandbox.untitled": "無標題",
    ...
    "profileSettings.changePasswordModal.title": "變更密碼",
    ...
    "profileSettings.deleteMyAccount.button.label": "刪除我的帳戶",
    ...
    "profileSettings.mfa.sms.countryCodeSelect.placeholder": "搜尋國碼",
    ...
    "profileSettings.profilePhotoSection.uploadProfilePhotoError.message":
      "上傳失敗。",
    "profileSettings.setPasswordModal.title": "設定密碼",
    ...
    "propertyCompletionActions.error.invalidPropertyForAutofill":
      "透過 AI 填寫的屬性配置無效",
    "propertyCompletionActions.error.noBlocksToAutofill":
      "沒有可透過 AI 填寫的內容",
    ...
    "publishTab.publishToWeb.button": "發佈至網路",
    "publishTab.publishToWeb.disabledByTeamspace.caption":
      "不能藉由團隊空間的設定將此頁面發佈到網站。",
    "publishTab.publishToWeb.disabledByWorkspace.caption":
      "不能藉由工作區設定將此頁面發佈到網站。",
    "publishTab.publishToWeb.hasFullAccess.caption":
      "發佈此頁面的靜態網站。能讓其他人查看、複製及重新混合。",
    "publishTab.publishToWeb.noFullAccess.caption":
      "你必須擁有此頁面的全部權限才能發佈至網路",
    "publishTab.publishToWeb.title": "發佈至網路",
    "publishTab.settings.liveOnWeb.title": "此頁面在網路為即時頁面",
    "publishTab.settings.liveOnWeb.unpublish": "取消發佈",
    "publishTab.settings.liveOnWeb.unpublishTooltip":
      "你必須擁有此頁面的全部權限才能取消發佈",
    "publishTab.settings.liveOnWeb.viewSite": "查看網站",
    ...
    "relationPropertyMenu2.connectedRelationGoogleDrive.searchPlaceholder":
      "在 Google Drive 或 Google Docs 連結中貼上",
    ...
    "search.filterMenu.moreFilters.inPage": "在",
    ...
    "search.filterMenu.onlyMatchTitlesToggle.label": "僅顯示標題",
    ...
    "search.result.currentPage.badge.text": "當前頁面",
    "search.searchActionMenuItem.fullSearch.description":
      "搜尋「{query}」的所有頁面內容",
    "search.searchActions.actions.text": "動作",
    "search.searchResultBuckets.bestMatches.text": "最相符項目",
    ...
    "search.searchResultBuckets.uniqueID.text": "ID 相符項目",
    ...
    "settings.workspaceAnalytics.usersTab.userTable.lastActiveTimestamp.noLastActive":
      "沒有活動",
    "shadowCursor.tooltips.breadcrumb": "查看你的上一個頁面",
    "shadowCursor.tooltips.createSubpageSlashMenu":
      "輸入 {slashpage} 以快速篩選",
    "shadowCursor.tooltips.enter": "輸入",
    "shadowCursor.tooltips.newPageSidebar": "建立你的第一個頁面",
    "shadowCursor.tooltips.openSlashMenu": "輸入 {slash} 以查看內容類型",
    "shadowCursor.tooltips.pressEnterSlashMenu": "按 {enter} 以建立頁面",
    "shadowCursorSnackbar.breadcrumb.label": "查看子頁面組織",
    "shadowCursorSnackbar.exitButton.label": "離開教學課程",
    "shadowCursorSnackbar.label.container":
      "步驟 {step}，共 {totalSteps} 個步驟：{message}",
    "shadowCursorSnackbar.newPageBlankLine.label": "使用功能表建立內容",
    "shadowCursorSnackbar.newPageSidebar.label": "建立頁面",
    "shadowCursorTutorialPopup.cta": "立即開始",
    "shadowCursorTutorialPopup.subtitle":
      "學習 3 個動作以建立和自訂你喜歡的 Notion 文件和專案。",
    "shadowCursorTutorialPopup.title": "3 步驟學會使用 Notion",
    "shareButtonIntroTooltip.title": "你可以在此處與隊友分享你的內容",
    "shareMenu.addFromSlack.label": "從 {integrationNameWithLogo} 加入人員",
    "shareMenu.backButton.iconButton": "返回至主共享功能表。",
    ...
    "sidebar.GuidedTutorialTooltip.content":
      "Notion 內沒有資料夾。頁面並不在此處，而是位於邊欄處。",
    "sidebar.addAPageButtonTeamToggle.addBlankPage": "空白頁面",
    "sidebar.addAPageButtonTeamToggle.addDocs": "文件",
    "sidebar.addAPageButtonTeamToggle.addMeeetingNotes": "會議記錄",
    "sidebar.addAPageButtonTeamToggle.addPages": "加入頁面",
    "sidebar.addAPageButtonTeamToggle.addProjectManagement": "專案和任務",
    "sidebar.addAPageButtonTeamToggle.addSprints": "專案任務及 Sprint",
    "sidebar.addAPageButtonTeamToggle.addWiki": "知識庫",
    "sidebar.addAPageButtonTeamToggle.moreTemplates": "更多模板",
    "sidebar.addAPageButtonTeamToggle.suggestedSection": "建議",
    "sidebar.addAPageButtonTeamToggle.tooltip": "加入頁面",
    "sidebar.addAPageOrTemplateButtonTeamToggle.tooltip": "加入頁面或模板",
    ...
    "sidebar.addTemplateToExistingTeam.wiki": "知識庫",
    "sidebar.appTemplate.confirmAdditional":
      "確定要加入另一項任務和專案模板嗎？",
    "sidebar.appTemplate.confirmAdditional.caption":
      "如果你的每個團隊空間只有 1 個模板，大多數團隊的任務和專案才會發揮最佳效果。",
    "sidebar.appTemplate.confirmAdditional.confirmAddAnyway.label": "仍要加入",
    "sidebar.appTemplate.confirmAdditionalAppTemplate":
      "確定要加入另一個 {templateType} 模板？",
    "sidebar.appTemplate.confirmAdditionalAppTemplate.caption":
      "如果每個團隊空間只有一個模板，{templateType} 模板的效果最好。",
    ...
    "sidebar.appTemplate.confirmAdditionalAppTemplate.existingAppsCaption":
      "{existingDatabaseTypes} 已存在於此團隊空間中。每個團隊空間只有一個模板時，此模板效果最好。",
    "sidebar.appTemplate.docsTitle": "文件",
    "sidebar.appTemplate.meetingsTitle": "會議記錄",
    "sidebar.appTemplate.projectsTitle": "專案和任務",
    "sidebar.appTemplate.sprintsTitle": "專案、任務及 Sprint",
    "sidebar.appTemplate.wikiTitle": "知識庫",
    ...
    "sidebar.outlinerTeamToggleButton.addPages": "加入頁面",
    ...
    "sidebar.outlinerTeamToggleButton.joinAsMemberLabel": "以成員身分加入",
    "sidebar.outlinerTeamToggleButton.joinAsOwnerLabel": "以擁有者身分加入",
    ...
    "sidebar.outlinerTeamToggleButton.upgradeSelfToOwnerLabel": "成為擁有者",
    ...
    "sidebar.shadowCursorCongrats.content":
      "Notion 中沒有任何資料夾。相反地，你可以在頁面中無限整理頁面。點選 {char} 以查看你的子頁面。",
    "sidebar.shadowCursorCongrats.header":
      "恭喜！你在頁面中建立了自己的第一個頁面。",
    ...
    "sidebarCreateTeamModal.footer.addApps": "加入 APP",
    ...
    "sidebarCreateTeamModal.teamScreen.teamNameLabel": "圖示和名稱",
    ...
    "sidebarCreateTeamModal.types.tasksDescription":
      "與你的團隊一同追蹤專案和任務",
    "sidebarCreateTeamModal.types.tasksTitle": "项目和操作",
    ...
    "sidebarItem.deleteSandbox.tooltip": "刪除",
    ...
    "sidebarSettingsButton.desktop.deleteSandbox": "刪除沙箱",
    "sidebarSettingsButton.desktop.dismiss": "關閉",
    "sidebarSettingsButton.desktop.dismissSandbox": "關閉",
    "sidebarSettingsButton.desktop.notionProjects": "Notion 專案",
    "sidebarSettingsButton.desktop.tryNotionProjects": "試用 Notion 專案",
    ...
    "slackAuthorizationErrors.webhookNotFound.errorMessage":
      "找不到 Slack 的 webhook。",
    "slackAutomations.remove.confirmation.acceptLabel": "刪除",
    ...
    "slackNotifications.learnMore.label": "了解如何升級。",
    ...
    "slashMenu.suggestedSection.title": "建議",
    "snackbar.aiAutofill.autofillInProgress":
      "AI 已更新第 {numPages} 頁上的「{propertyName}」",
    "snackbar.aiAutofill.autofillStarting":
      "AI 正在更新第 {numPages} 頁上的「{propertyName}」",
    "snackbar.aiAutofill.close": "關閉",
    "snackbar.aiAutofill.completedAutofill":
      "AI 已更新第 {numTotalPages} 頁 {numFilledPages} 上的「{propertyName}」",
    "snackbar.aiAutofill.undo": "還原",
    "snackbar.aiAutofill.undoAndStop": "還原和停止",
    "snackbar.undo.title": "還原",
    "space.spaceContentDuplicationStatus.completed": "已完成",
    "space.spaceContentDuplicationStatus.failed": "失敗",
    "space.spaceContentDuplicationStatus.started": "已開始",
    ...
    "spaceBasicSettings.exportContentSection.exportButton.label":
      "匯出所有工作區內容",
    "spaceBasicSettings.exportContentSection.exportInProgress": "匯出進行中",
    ...
    "spaceInviteLinkEmailVariantdirected_to_joiners.body.label":
      "{name} 已邀請你至 {spaceName}。點選下面的連結來加入！",
    ...
    "spacePermissionsSettings.userTable.pagesColumn.header": "頁面",
    ...
    "spaceSubscriptionBillingV2.additionalFeatures": "額外功能",
    ...
    "spaceSubscriptionBillingV2.applyCouponModal.successMessage":
      "已套用優待券！",
    "spaceSubscriptionBillingV2.applyCouponModal.title": "套用優待券",
    "spaceSubscriptionBillingV2.billedTo": "付款人",
    "spaceSubscriptionBillingV2.billing": "帳單",
    "spaceSubscriptionBillingV2.billingPeriod": "帳單週期",
    "spaceSubscriptionBillingV2.cancelButton.label": "取消",
    "spaceSubscriptionBillingV2.cancelChanges": "取消變更",
    ...
    "spaceSubscriptionBillingV2.changeBillingInterval.helpButton.label":
      "了解此變更將如何影響帳單。",
    "spaceSubscriptionBillingV2.changeBillingInterval.title": "變更帳單間隔",
    "spaceSubscriptionBillingV2.changePlan": "變更方案",
    "spaceSubscriptionBillingV2.changeVATIDModal.subtitle": "請加入你的國碼",
    "spaceSubscriptionBillingV2.changeVATIDModal.title": "變更 VAT/GST 編號",
    "spaceSubscriptionBillingV2.changeYourAddressModal.title": "變更地址",
    "spaceSubscriptionBillingV2.editInformation": "編輯資訊",
    "spaceSubscriptionBillingV2.editMethod": "編輯方式",
    "spaceSubscriptionBillingV2.editNumber": "編輯號碼",
    "spaceSubscriptionBillingV2.editPeriod": "編輯期限",
    "spaceSubscriptionBillingV2.invoiceSummary":
      "{invoiceStatus} · {formattedAmount}",
    "spaceSubscriptionBillingV2.invoices": "發票",
    "spaceSubscriptionBillingV2.offline.message": "請上線管理帳單。",
    "spaceSubscriptionBillingV2.paymentDetails": "付款詳細資料",
    "spaceSubscriptionBillingV2.paymentMethod": "付款方式",
    "spaceSubscriptionBillingV2.paymentMethod.creditCard":
      "末碼為 {lastFourDigits} 的 {creditCardBrand}",
    "spaceSubscriptionBillingV2.paymentMethodType.creditCard": "信用卡",
    "spaceSubscriptionBillingV2.plan": "方案",
    "spaceSubscriptionBillingV2.planType.business": "商業版",
    "spaceSubscriptionBillingV2.planType.enterprise": "企業版",
    "spaceSubscriptionBillingV2.planType.personal": "個人版",
    "spaceSubscriptionBillingV2.planType.plus": "加值版",
    "spaceSubscriptionBillingV2.priceAndRenewalDate":
      "依照 {interval} 的 {planCharge}。 {renewalOrCancellationMessage} {renewalDate}",
    "spaceSubscriptionBillingV2.priceAndRenewalDate.cancels":
      "依照 {interval} 的 {planCharge}。取消 {date}",
    "spaceSubscriptionBillingV2.priceAndRenewalDate.priceOnly":
      "依照 {interval} 的 {planCharge}",
    "spaceSubscriptionBillingV2.priceAndRenewalDate.renews":
      "依照 {interval} 的 {planCharge}。更新 {date}",
    "spaceSubscriptionBillingV2.removeFromPlan": "自方案移除",
    "spaceSubscriptionBillingV2.renews": "更新",
    "spaceSubscriptionBillingV2.resubscribe": "續訂",
    ...
    "spaceSubscriptionBillingV2.subscriptionSettingsSection.billingInterval.value.yearly":
      "年繳",
    "spaceSubscriptionBillingV2.upcomingInvoice": "下一張發票",
    ...
    "spaceSubscriptionBillingV2.useCreditModal.warning":
      "為帳號套用點數是<bold>無法還原</bold>的動作。",
    "spaceSubscriptionBillingV2.vatGst": "VAT/GST 編號",
    ...
    "spaceSubscriptionBillingV2.viewInvoice": "查看發票",
    ...
    "spaceSubscriptionUpdateModal.billingInterval.title": "變更帳單週期",
    "spaceSubscriptionUpdateOrderSummary.estimatedFuturePrice": "預估未來價格",
    "spaceSubscriptionUpdateOrderSummary.total": "總計",
    "spaceSubscriptionUpdateOrderSummary.totalPrice": "總額",
    ...
    "spaceSubscriptionUpgradeModal.creditCard.genericError":
      "我們無法處理你的卡片。請再試一次。",
    "spaceSubscriptionUpgradeModal.effectiveToday.header": "今日生效",
    ...
    sprintBoard_0_0: "了解在 Notion 中如何管理 Sprint，",
    sprintBoard_0_1: "瀏覽此處",
    sprintBoard_0_2: "。",
    ...
    "subscription.payment_status_banner.confirm_payment": "確認付款",
    "subscription.payment_status_banner.confirmation_required.past_due.workspace_owner":
      "請確認{overdueInvoiceCount, plural, one {你的訂閱付款} other {{overdueInvoiceCount} 筆付款}}，否則可能即將遺失 Notion 的存取權限。",
    "subscription.payment_status_banner.confirmation_required.unpaid.member":
      "Notion 的存取權限僅限於查看。聯絡工作區擁有者以更新你工作區的付款方式。",
    "subscription.payment_status_banner.confirmation_required.unpaid.workspace_owner":
      "Notion 的存取權限僅限於查看。確認{overdueInvoiceCount, plural, one {你的訂閱付款} other {{overdueInvoiceCount} 筆付款}}以恢復全部權限。",
    "subscription.payment_status_banner.payment_failed.past_due.member":
      "請聯絡工作區擁有者以更新你的付款方式，否則可能即將遺失 Notion 的存取權限。",
    "subscription.payment_status_banner.payment_failed.past_due.workspace_owner":
      "我們無法處理{overdueInvoiceCount, plural, one {你的上一筆付款} other {{overdueInvoiceCount} 筆付款}}。請更新你的付款方式，否則可能即將遺失 Notion 的存取權限。",
    ...
    "subscription.payment_status_banner.payment_failed.unpaid.workspace_owner":
      "Notion 的存取權限僅限於查看，因為我們無法處理{overdueInvoiceCount, plural, one {你的上一筆付款} other {{overdueInvoiceCount} 筆付款}}。更新你的付款資訊以恢復全部權限。",
    ...
    "subscriptionErrors.cancelAddOnsWithoutSubscription":
      "如果沒有有效的訂閱，就不能請求取消附加元件。",
    "subscriptionErrors.cancelNonExistentAddOn":
      "不能取消一個不存在的附件元件 {addOnId}。",
    ...
    "subscriptionUpdateModal.billedTo": "付款人",
    "subscriptionUpdateModal.confirmationButton": "確認變更",
    "subscriptionUpdateModal.paymentDetails": "付款詳細資料",
    ...
    "syncedCollectionIndicators.googleDriveFile.label": "檔案",
    ...
    "teamActions.teamScreen.privateTeam.description":
      "只有成員才能查看團隊空間及其內容。",
    "teamAddAppTemplateTooltip.content": "開始使用專案、文件、知識庫等更多內容",
    "teamAddAppTemplateTooltip.header": "將模板加入到你的團隊空間",
    ...
    "teamInviteLinkPageError.archivedTeam.title": "糟糕，此團隊空間已歸檔。",
    "teamInviteLinkPageError.backToMyContentButton.label": "返回我的內容",
    "teamInviteLinkPageError.inviteLinkDisabled.title":
      "糟糕，此團隊空間已停用邀請連結。",
    "teamInviteLinkPageError.noAccess.message":
      "如有任何問題，請聯絡你的工作區擁有者。",
    "teamInviteLinkPageError.nonSpaceMember.title": "糟糕，你不是工作區成員。",
    "teamInviteLinkPreview.closedTeam.description":
      "{users} 已邀請你加入團隊空間。要求加入團隊空間的存取權限，團隊空間擁有者即會核准或拒絕你的要求。",
    "teamInviteLinkPreview.closedTeam.title": "要求 {teamName} 的存取權限！",
    "teamInviteLinkPreview.oneOwnerAndMembers.description":
      "{name} 和 {numMembers} 位成員",
    ...
    "teamInviteLinkPreview.privateTeam.description":
      "你已受邀加入團隊空間。要求加入團隊空間的存取權限，團隊空間擁有者即會核准或拒絕你的要求。",
    "teamInviteLinkPreview.privateTeam.title": "要求私人團隊空間的存取權限！",
    "teamInviteLinkPreview.twoOwners.description":
      "{firstName} 和 {secondName}",
    "teamInviteLinkPreview.twoOwnersAndMembers.description":
      "{firstName}、{secondName} 及 {numMembers} 位成員",
    ...
    "teamInviteLinkRequestPage.privateTeamspace.label": "私人團隊空間",
    ...
    "teamPermissionsSettings.teamspace.guest.disabledPermissionitem.description":
      "團隊空間訪客不能有完整存取權限。",
    "teamPickerButton.addToPrivate": "加入到私人",
    "teamPickerButton.teamItem.teamMemberCount":
      "{numberOfMembers, plural, other {{numberOfMembers} 位成員}}",
    "teamPlan.title": "團隊版",
    "teamRequestButton.requestButton.label": "要求",
    ...
    "templateHelpers.personas.learnNotionThreeSteps": "3 步驟學會使用 Notion",
    ...
    "templateHelpers.templates.marketingWiki": "行銷知識庫",
    ...
    "templateHelpers.useCase.wiki": "知識庫",
    ...
    "text.miniPeek.placeholder": "新增說明",
    ...
    "toggleBlockFormat.emptyBlock.placeholderText":
      "空的折疊列表。按一下或拖動區塊到這裡。",
    "toggleButton.close": "關閉",
    "toggleButton.open": "開啟",
    ...
    "topbar.moreButton.getNotified": "收到通知",
    ...
    "transactionErrors.activityEditsMaxSize.message":
      "你已超出每頁的編輯次數上限。",
    "transactionErrors.aiInference.invalid": "AI 屬性無效。",
    "transactionErrors.aiInferencePromptExceedsMaxLength": "AI 屬性提示太長。",
    ...
    "transactionErrors.cannotDeleteTasksBacklogEmptySprintPropertyFilter":
      "任務待辦需求 Sprint 視圖有個無法刪除的空 Sprint 狀態屬性篩選器。",
    "transactionErrors.cannotDeleteTasksCurrentSprintPropertyFilter":
      "任務目前 Sprint 視圖有無法刪除的目前 Sprint 狀態屬性篩選。",
    ...
    "transactionErrors.cannotEditTypedPropertyRelation":
      "此屬性不能變更其關聯性。",
    "transactionErrors.cannotEditTypedPropertyRollup": "此屬性不能變更其匯總。",
    "transactionErrors.cannotEditTypedPropertyType": "此屬性不能變更其類型。",
    ...
    "transactionErrors.cannotMutateTasksBacklogEmptySprintPropertyFilter":
      "任務待辦需求 Sprint 視圖有個無法改變的空 Sprint 狀態屬性篩選器。",
    "transactionErrors.cannotMutateTasksCurrentSprintPropertyFilter":
      "任務目前 Sprint 視圖有無法修改的目前 Sprint 狀態屬性篩選。",
    ...
    "transactionErrors.pmAnnouncement.invalid": "Notion 專案示範頁面無法修改。",
    ...
    "transactionErrors.workspaceTopLevelOperationNotAllowed.message":
      "此工作區已鎖定修改側邊欄的工作區部分。",
    "transactionHelpers.requestTooLargeError.message": "抱歉，該要求太大。",
    ...
    "typedMoveBlockMenu.pagesSection.title": "頁面",
    "typedMoveBlockMenu.teamsSection.title": "團隊空間",
    ...
    "unfurlingHelpers.unfurlResponseErrorDescription.serverError":
      "糟糕！似乎發生「{integrationName}」伺服器錯誤。已收到錯誤代碼「{statusCode}」。",
