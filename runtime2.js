// ==UserScript==
// @name         Notion-zh_CN ios 端 紫霞浏览器 notion 汉化测试脚本。
// @namespace    http://tampermonkey.net/
// @version      0.0.2
// @description  Notion-zh_CN ios 端 紫霞浏览器 notion 汉化测试脚本
// @author       reamd7
// @match        *://www.notion.so/*
// @grant        none
...
// @license      MIT
// ==/UserScript==
// 基于react fiber的动态注入方案，但是不知道为什么还是有些地方没办法
//
// 剩余的实现使用 https://github.com/nancheung97/notion-zh_CN 0.1.0版本的实现
//
(function() {
  try {
  ...
  function insert() {
    if (
      ...
      // 第一步注入全局国际化的字段
      cur = root._reactRootContainer._internalRoot.current;
      while (cur.elementType?.displayName !== "IntlProvider") {
        cur = cur.child;
      }
      cur.pendingProps.messages = Object.assign(cur.pendingProps.messages, {
        ...
        "UpdateSidebarFollowControl.following.caption":
          "接收所有更新和评论通知",
        ...
        "UpdateSidebarFollowControl.unfollow.caption": "不接收通知",
        ...
        "allTimeZones.America/Argentina/Rio_Gallegos":
          "美洲/阿根廷/里奥加耶戈斯",
        ...
        "appVersionMenuItem.updateStateForApp.checking.message":
          "正在检查更新⋯",
        ...
        "blockPermissionsSettings.permissionItem.groupAccess":
          "与{groupName}分享",
        ...
        "botWithTokenSettings.revokeTokenModal.acceptButton.label":
          "撤销 API 令牌",
        ...
        "collectionEditViewButtonPopup.mobileEditViewModal.doneButtonText":
          "完成",
        ...
        "comments.learn": "了解评论",
        "configureRelationModal.relationProperty.createModal.cancelButton":
          "取消",
        ...
        "configureRelationModal.relationProperty.createModal.helpCenterLinkMobile":
          "关系用法",
        "configureRelationModal.relationProperty.createModal.noResults":
          "无结果",
        ...
        "csatPopup.feedbackPrompt.defaultlabel":
          "你对使用 Notion 的满意度如何？",
        ...
        "database.collectionGroupHeader.actions.addNewPage.tooltip":
          "创建新页面",
        ...
        "database.editPropertyButtonPopup.extensionMenuSectionTitleAdvanced":
          "高级",
        "database.editPropertyButtonPopup.extensionMenuSectionTitleBasic":
          "基本",
        ...
        "database.filterAndSort.searchPersonPropertyMenuItem.errorMessage":
          "出了些问题。",
        "database.filterAndSort.selectPropertyValue.noResults.message":
          "无结果",
        "database.filterAndSort.selectPropertyValue.prompt": "选择选项",
        "database.filterAndSort.selectPropertyValue.searchPlaceholder":
          "搜索选项⋯",
        "database.filterAndSortMenu.propertyButton.label": "属性",
        "database.filterMenu.addFilterButtonTitle": "添加筛选器",
        "database.filterMenu.addFilterGroupButtonCaption":
          "一个组可包含多个筛选器",
        ...
        "database.filterMenu.rollupPropertyValue.mobileMenu.title":
          "设置筛选器",
        ...
        "database.loadMoreButtonTitle":
          "加载<regular>其余 {count} 项</regular>",
        "database.mobileBoardAggregationMenu.title": "表汇总",
        "database.mobileFilterAndSort.selectMobileModal.title": "选择",
        "database.mobileFilterAndSortMenu.property.buttonMenuItem.label":
          "属性",
        ...
        "database.relationProperty.createModal.databaseSelect.label":
          "选择数据库",
        ...
        "database.relationProperty.createModal.helpCenterLinkMobile":
          "了解关系",
        ...
        "database.relationProperty.newRelation.helpCaption":
          "了解关联关系和汇总",
        ...
        "database.selectPropertyOptionEditMenu.deleteModal.confirmButton":
          "移除",
        ...
        "developerIntegrationsList.subtitle":
          "创建、审阅和编辑开发信息和凭证。",
        ...
        "developerInternalIntegraion.integrationType.integration.title":
          "公开集成",
        ...
        "edit.blockDeletedEditStyles.defaultLabel": "删除的块",
        "edit.blockDeletedEditStyles.factoryLabel": "删除的块",
        ...
        "emailActivitySection.authorPhrase.forOneAuthor.label":
          "<b>{author}</b>",
        ...
        "enhancedSidebarFeatureTour.pinPages.primaryText":
          "分享页面请在这里整理",
        ...
        "evernoteActions.authenticatingWithEvernote.loadingMessage":
          "Evernote 授权中⋯",
        "evernoteActions.loginPopupModal.title":
          "印象笔记国际版（Evernote）登录",
        ...
        "exportEmail.exportEmailText":
          "你的 Notion 导出已准备就绪： {downloadURL}",
        ...
        "exportModal.exportFormatButton.markdownAndCSV.label":
          "Markdown 和 CSV",
        ...
        "faq.confluenceImport.question":
          "如何将我的 Confluence 工作区导入Notion？",
        ...
        "faq.freePlanForEducation.question":
          "对于学生和教育工作者的免费计划呢？",
        ...
        "faq.howToApplyForStartupCredit.question":
          "如何申请获得 US$1,000 的积分？",
        ...
        "fronUseCases.mobileAltImage.logosOfReplacedSoftware":
          "可替代软件的 Logo",
        "frontNewsletterSignupInput.formstackError":
          "发生错误。请尝试再次订阅。",
        ...
        "frontPricingCard.freePlan.attribute.shareWithGuests":
          "与 5 位访客分享",
        ...
        "historyModalActions.restoringPreviousVersion.loadingMessage":
          "恢復中⋯",
        ...
        "inviteUserButton.tooltip.adminsOnlyMessage":
          "只有管理员可以添加成员。",
        ...
        "mediaPicker.menuItem.connectMoreGoogleAccounts.label":
          "绑定另一个帐户",
        ...
        "newBlock.embed.fuzzySearchKeywords":
          "Embed iFrame 嵌入 qianru qian'ru",
        ...
        "newBlock.header.fuzzySearchKeywords":
          "Heading 1 # 标题 biaoti biao'ti",
        ...
        "notificationSettings.desktopNotificationSettings.title":
          "桌面推送通知",
        ...
        "notionAppContainer.dialog.mismatchedOriginURL.okayButton.label":
          "好的",
        ...
        "oauthAuthorizationPage.permissionStep.continueButton.label":
          "选择页面",
        ...
        "onboardingActions.onboardingErrorDialog.startOverButton.label":
          "重新开始",
        ...
        "onboardingInvite.emails.addMoreOrInviteInBulkText": "添加或集体邀请",
        ...
        "onboardingProfile.dialogError.photoUploadFailure.message":
          "上传失败。",
        ...
        "onboardingProfile.mobileStage.subtitle":
          "首先，请向我们介绍一下你自己。",
        ...
        "onboardingWorkspaceCreate.stage.subtitle":
          "为你的队友填写一些详细信息。",
        ...
        "onboardingWorkspaceCreate.workspaceNameInput.hint":
          "你公司或组织的名称。",
        ...
        "onboardingWorkspaceUseCaseSetup.goToNotionButton.label":
          "带我去 Notion",
        ...
        "onboardingWorkspaceUseCaseSetup.notesUseCaseButton.description":
          "捕捉想法，然后与团队分享。",
        "onboardingWorkspaceUseCaseSetup.notesUseCaseButton.label":
          "文档和笔记",
        ...
        "onboardingWorkspaceUseCaseSetup.personalUseCaseButton.callout":
          "导入于",
        "onboardingWorkspaceUseCaseSetup.segmentedButton.personalLabel":
          "为我自己",
        "onboardingWorkspaceUseCaseSetup.segmentedButton.teamLabel":
          "为我和团队",
        ...
        "page.backlinks.privatePages":
          "{count，plural，other{{count}个个人主页}}",
        ...
        "pageCover.fileType.caption":
          "宽于 {idealImageWidth} 像素的图片效果最佳。",
        ...
        "pageCover.nasaEvaDuringSkylab3.title":
          "天空实验室 3 号飞行期间舱外活动",
        ...
        "pageCover.nasaRobertStewartSpacewalk2.title":
          "罗伯特·斯图尔特太空漫步 2",
        ...
        "pageCover.rijksmuseumVermeerTheMilkmaid.subtitle":
          "1660，倒牛奶的女仆",
        ...
        "pageTemplateModal.modifiedTemplateDialog.discardEditsButton.label":
          "放弃",
        ...
        "pageViewBlock.collectionHeader.navigate.tooltip":
          "点击以回到原始数据库。",
        ...
        "passwordSettings.genericPasswordSaveError":
          "保存密码时出错。请稍后再试。",
        ...
        "pricingGrid.planAttribute.fileUploads.trial.5MbFileUploadLimit":
          "试用版 5 MB",
        "pricingGrid.planAttribute.fileUploads.value.5MbFileUploadLimit":
          "5 MB",
        ...
        "profileSettings.profilePhotoSection.uploadPhotoButton.label":
          "上传照片",
        ...
        "pushNotification.imageInPushNotification.placeholder":
          "{imageEmoji} 图片",
        ...
        "regionSettings.region.subtitle":
          "日期、数字和货币的默认符号格式不同。",
        ...
        "removeUsersFromSpace.nonexistentSpace.error.message":
          "不存在的工作空间。",
        ...
        "samlErrors.emailNotConfigured.message":
          "该邮箱地址未配置使用 SAML SSO",
        ...
        "search.recentMenuItem.createdDateAfter.subtitle":
          "创建于 {startDate}之后",
        ...
        "searchErrorMenuItem.errorPrompt.goOnline":
          "连接到网络以获取更多结果。",
        ...
        "searchPageFilter.searchTokenFilter.tokenInput.placeholder":
          "搜索页面⋯",
        ...
        "selectionLinkButton.search.createNewLinkPlaceholder":
          "粘贴链接或搜索页面",
        ...
        "sharedWithMePopover.search.subtitle":
          "他人与你分享的页面将显示在这里。",
        ...
        "sidebar.sharedPagesSection.tooltip":
          "只有你和分享过页面的人才能访问。",
        ...
        "sidebarStudentPlanPrompt.eligible.getFreePrompt":
          "获取免费个人专业计划",
        ...
        "sidebarSwitcherMultiAccount.addAccountModal.cancelButton.label":
          "取消",
        ...
        "spaceBasicSettings.PublicHomePageSection.dropdownButton.clearHomePage":
          "清除主页",
        "spaceBasicSettings.PublicHomePageSection.dropdownLabel":
          "Web上共享的页面",
        ...
        "spacePermissionSettings.memberUpsell.alternativeTrialLabel":
          "免费试用",
        ...
        "spacePermissionsSettings.groupsTab.userGroup.addUserButton.label":
          "添加",
        ...
        "spacePermissionsSettings.spaceMembers.inviteLink.copyButton":
          "复制链接",
        "spacePermissionsSettings.spaceMembers.inviteLink.shareButton":
          "分享链接",
        ...
        "spacePermissionsSettings.userTable.accessLevelColumn.header":
          "访问权限",
        ...
        "spaceSubscriptionBilling.changeBillingAddressModal.stateInput.label":
          "州或省",
        "spaceSubscriptionBilling.changeBillingAddressModal.title":
          "更改账单地址",
        ...
        "spaceSubscriptionBilling.invoicesSection.viewInvoiceButton":
          "查看发票",
        ...
        "spaceSubscriptionBilling.setPaymentMethod.achOrWireTransferOption.description":
          "通过电子邮件接收发票",
        "spaceSubscriptionBilling.setPaymentMethod.payWithCardOption":
          "用卡片付款",
        ...
        "spaceSubscriptionUpgradeModal.orderSummary.personalPlan":
          "个人专业套餐",
        ...
        "studentNotEligibleModal.numberedList.promoCodeItem.message":
          "有教育优惠码？",
        "studentNotEligibleModal.numberedList.promoCodeItem.submitButton":
          "提交",
        ...
        "subscriptionHelpers.paymentMethod.invoice.caption":
          "通过电子邮件接收账单",
        ...
        "subscriptionSettings.invalidPromoCodeError.message":
          "此促销代码无效。",
        ...
        "subscriptionUpgradeDetails.perUserPerMonthPricing.label":
          "每人{br}每月",
        ...
        "topbar.presenceIndicator.hiddenUsers.lastViewedBy.tooltip":
          "上次查看者",
        ...
        "trelloImportOption.actionsMenu.connectAnotherAccount":
          "绑定另一个帐户",
        ...
        "updatesModal.allPagesTab.emptyPrompt":
          "工作区中页面的更新将显示在这里。",
        ...
        "userCreditSettings.otherWaysToEarnCreditSection.totalCreditSummaryText":
          "赚取的总积分 ",
        "userCreditSettings.otherWaysToEarnCreditSection.webApp.actionLink":
          "访问",
        ...
        "userPermissionsMenu.removePermissionsModal.removeSelfButton.label":
          "删除",
        ...
        "userPermissionsMenu.removePermissionsModal.removeUserButton.label":
          "移除",
...
// https://github.com/nancheung97/notion-zh_CN 0.1.0 版本
function runtimeObserver() {
  ...
  I18n.install("zh", {
    ...
    "Copy link": "复制链接",
    "Open in Android app": "在安卓应用中打开",
    "Open in Mac app": "在 Mac 应用中打开",
    "Open in Windows app": "在 Windows 应用中打开",
    "Open in iOS app": "在 iOS 应用中打开",
    Undo: "撤消",
    Redo: "重做",
    "Page history": "页面历史记录",
    ...
    Text: "文本",
    "Just start writing with plain text.": "以纯文本开始书写。",
    Page: "页面",
    "Embed a sub-page inside this page.": "在该页面中嵌入子页面。",
    "Link to page": "链接到页面",
    "Link to an existing page.": "链接到现有页面。",
    "Create linked database": "创建链接数据库",
    "Create custom views for a database.": "为数据库创建自定义视图。",
    "Synced block": "同步块",
    "Sync content across pages.": "同步所有页面的内容。",
    "To-do list": "待办清单",
    "Track tasks with a to-do list.": "使用待办清单追踪任务。",
    "Heading 1": "标题 1",
    "Big section heading.": "大大的标题。",
    "Heading 2": "标题 2",
    "Medium section heading.": "中标题。",
    "Heading 3": "标题 3",
    "Small section heading.": "小标题。",
    Image: "图片",
    "Upload or embed with a link.": "上传或以链接嵌入。",
    "Web bookmark": "网页书签",
    "Save a link as a visual bookmark.": "通过链接创建可视化书签。",
    Divider: "分隔线",
    "Visually divide blocks.": "在视觉上创建分隔。",
    Code: "代码",
    "Capture a code snippet.": "摘取代码段。",
    Quote: "引用",
    "Capture a quote.": "摘取引用。",
    "Bulleted list": "项目符号列表",
    "Create a simple bulleted list.": "创建一个简单的项目符号列表。",
    "Numbered list": "有序列表",
    "Create a list with numbering.": "创建一个带有序号的列表。",
    "Toggle list": "折叠列表",
    "Toggles can hide and show content inside.":
      "折叠列表可以选择性隐藏或显示内部内容。",
    File: "文件",
    Video: "视频",
    "Embed from YouTube, Vimeo...": "从 YouTube、Vimeo 等嵌入视频。",
    Audio: "音频",
    "Embed from SoundCloud, Spotify...": "从 SoundCloud、Spotify 等嵌入音频。",
    Embed: "嵌入",
    "For PDFs, Google Maps, and more.": "适用于 PDF、谷歌地图等。",
    "Google Drive": "谷歌云端硬盘",
    "Embed a Google Doc, Google Sheet...": "嵌入谷歌文档、谷歌表格等。",
    Figma: "Figma",
    "Embed a Figma file.": "嵌入 Figma 文件。",
    Loom: "Loom",
    "Embed a Loom recording.": "嵌入 Loom 录像。",
    Typeform: "Typeform",
    "Embed a Typeform.": "嵌入 Typeform 表单。",
    CodePen: "CodePen",
    "Embed a CodePen.": "嵌入 Codepen 项目。",
    Tweet: "推文",
    "Embed a Tweet.": "嵌入推文。",
    "GitHub Gist": "GitHub Gist",
    "Embed a Gist from GitHub.": "嵌入 GitHub Gist。",
    "Google Maps": "谷歌地图",
    "Embed a Google Map.": "嵌入谷歌地图。",
    Framer: "Framer",
    "Embed a Framer prototype.": "嵌入 Framer 原型。",
    Invision: "Invision",
    "Embed an Invision project.": "嵌入 Invision 项目。",
    "Block equation": "方程式块",
    "Display a standalone math equation.": "显示独立的数学方程式块。",
    PDF: "PDF",
    "Embed a PDF.": "嵌入 PDF 文件。",
    "Template button": "模板按钮",
    "Duplicate blocks with a click.": "点击即可快速重复特定区块。",
    Breadcrumb: "导航栏",
    "Show the current page location.": "显示目前页面的位置。",
    Callout: "标注",
    "Make writing stand out.": "将文字加强突出。",
    "Table of contents": "目录",
    "Show an outline of your page.": "显示页面大纲。",
    Whimsical: "Whimsical",
    "Embed a Whimsical board.": "嵌入 Whimsical 画板。",
    Miro: "Miro",
    "Embed a Miro board.": "嵌入 Miro 画板。",
    Abstract: "Abstract",
    "Embed an Abstract project.": "嵌入 Abstract 项目。",
    Sketch: "Sketch",
    "Embed a Sketch document.": "嵌入Sketch文档。",
    Excalidraw: "Excalidraw",
    "Embed an Excalidraw whiteboard.": "嵌入Excalidraw白板。",
    Replit: "Replit",
    "Embed a repl.": "嵌入Repl。",
    "Table - Inline": "表格・内嵌",
    "Create a table inline in this page.": "在该页面中创建内嵌表格。",
    "Board - Inline": "看板・内嵌",
    "Create a kanban board inline in this page.": "在该页面中创建内嵌看板。",
    "Gallery - Inline": "画廊・内嵌",
    "Create a gallery inline in this page.": "在该页面中创建内嵌画廊。",
    "List - Inline": "列表・内嵌",
    "Create a list inline in this page.": "在该页面中创建内嵌列表。",
    "Calendar - Inline": "日历・内嵌",
    "Create a calendar inline in this page.": "在该页面中创建内嵌日历。",
    "Timeline - Inline": "时间轴・内嵌",
    "Create a timeline inline in this page.": "在该页面中创建内嵌时间轴。",
    ...
    "List - Full page": "列表・整页",
    "Create a list as its own page.": "创建一个列表作为子页面。",
    "Calendar - Full page": "日历・整页",
    "Create a calendar as its own page.": "创建一个日历作为子页面。",
    "Timeline - Full page": "时间轴・整页",
    "Create a timeline as its own page.": "创建一个时间轴作为子页面。",
    // =====================================
    Duplicate: "制作副本",
    Comment: "评论",
    "Turn into": "转换成",
  ...
  const NotionAppList = window.document.querySelectorAll(
    ".notion-overlay-container"
  );
  NotionAppList.forEach(function(NotionApp) {
    translate(NotionApp);
