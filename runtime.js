...
function runtimeObserver() {
  ...
  I18n.install('zh', {
    ...
    // ==========================
        ...
        "Toggle list": "折叠列表",
        "Toggles can hide and show content inside.": "折叠列表可以选择性隐藏或显示内部内容。",
        "File": "文件",
        "Video": "视频",
  ...
  const NotionAppList = window.document.querySelectorAll(".notion-overlay-container");
  NotionAppList.forEach(NotionApp => {
    translate(NotionApp);
